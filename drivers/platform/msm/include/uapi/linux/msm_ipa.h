...
enum ipa_client_type {
	...
	IPA_CLIENT_QDSS_CONS		= IPA_CLIENT_MHI_QDSS_CONS,
	...
	IPA_CLIENT_Q6_V2X_UNICAST_CONS          = 143,
	...
	IPA_CLIENT_TELEVM_PROD			= 174,
	IPA_CLIENT_TELEVM_CONS			= 175,

	/* RESERVED PROD			= 176, */
	IPA_CLIENT_ETHERNET2_QOS2_CONS		= 177,

	/* RESERVED PROD			= 178, */
	IPA_CLIENT_AP_IC_EXCEPTION_CONS	 	= 179,

	/* RESERVED PROD			= 180, */
	IPA_CLIENT_ETHERNET_QOS2_CONS		= 181,
...
#define IPA_CLIENT_ETHERNET3_PROD IPA_CLIENT_ETHERNET3_PROD
...
#define IPA_CLIENT_IS_Q6_NON_ZIP_CONS(client) \
	...
	(client) == IPA_CLIENT_Q6_AUDIO_DMA_MHI_CONS || \
	(client) == IPA_CLIENT_Q6_CV2X_DECIPHER_CONS || \
	(client) == IPA_CLIENT_Q6_V2X_UNICAST_CONS)
