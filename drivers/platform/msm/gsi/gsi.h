...
enum gsi_evt_chtype_v7_0 {
	GSI_V7_0_EVT_CHTYPE_MHI_EV = 0x0,
	GSI_V7_0_EVT_CHTYPE_XHCI_EV = 0x1,
	GSI_V7_0_EVT_CHTYPE_GPI_EV = 0x2,
	GSI_V7_0_EVT_CHTYPE_XDCI_RX_EV = 0x3,
	GSI_V7_0_EVT_CHTYPE_WDI2_EV = 0x4,
	GSI_V7_0_EVT_CHTYPE_GCI_EV = 0x5,
	GSI_V7_0_EVT_CHTYPE_WDI3_RX_EV = 0x6,
	GSI_V7_0_EVT_CHTYPE_MHIP_EV = 0x7,
	GSI_V7_0_EVT_CHTYPE_AQC_RX_EV = 0x8,
	GSI_V7_0_EVT_CHTYPE_11AD_EV = 0x9,
	GSI_V7_0_EVT_CHTYPE_MHIC_EV = 0xA,
	GSI_V7_0_EVT_CHTYPE_QDSS_EV = 0xB,
	GSI_V7_0_EVT_CHTYPE_RTK_EV = 0xC,
	GSI_V7_0_EVT_CHTYPE_NTN3_RX_EV = 0xD,
	GSI_V7_0_EVT_CHTYPE_WDI3M_V2_RX_EV = 0xE,
	GSI_V7_0_EVT_CHTYPE_WDI3_V2_RX_EV = 0XF,
	GSI_V7_0_EVT_CHTYPE_WDI4_RX_EV = 0X10,
	GSI_V7_0_EVT_CHTYPE_RTK3_EV = 0x11,
	GSI_V7_0_EVT_CHTYPE_NTN3_TX_EV = 0x12,
	GSI_V7_0_EVT_CHTYPE_AQC_TX_EV = 0x13,
	GSI_V7_0_EVT_CHTYPE_XDCI_TX_EV = 0x14,
	GSI_V7_0_EVT_CHTYPE_WDI3_TX_EV = 0x15,
	GSI_V7_0_EVT_CHTYPE_WDI3_V2_TX_EV = 0x16,
	GSI_V7_0_EVT_CHTYPE_WDI3M_V2_TX_EV = 0X17,
...
/**
 * gsi_wdi4_wikiki_channel_scratch - WDI 4 protocol, wikiki chipset
 ...
 * @qmap_id: Rx only, used for setting metadata register in IPA, Read only field
            for MCS, Write for SW
 * @bank_id: TX only, used for setting BANK ID in event ring element
 * @vdev_id: TX only, used for setting VDEV ID in event ring element
 * @pmac_id: TX only, used for setting PMAC ID in event ring element
 */

struct __packed gsi_wdi4_channel_scratch {
