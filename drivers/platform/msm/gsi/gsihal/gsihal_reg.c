...
static const char *gsireg_name_to_str[GSI_REG_MAX] = {
	...
	__stringify(GSI_GSI_INST_RAM_0),
...
static struct gsihal_reg_obj gsihal_reg_objs[GSI_VER_MAX][GSI_REG_MAX] = {
	...
	/* GSIv6_0 */
	[GSI_VER_6_0][GSI_GSI_IRAM_PTR_INT_NOTIFY_MCS] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00004470, 0, 0 },
	[GSI_VER_6_0][GSI_GSI_INST_RAM_n] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	-1, 0, 0},
	...
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_1] = {
	gsireg_construct_ch_k_cntxt_1_v3_0, gsireg_parse_ch_k_cntxt_1_v3_0,
	0x00018004, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_2] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018008, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_3] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0001800c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_4] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018010, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_5] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018014, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_6] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018018, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_7] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0001801c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_CNTXT_8] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018020, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_CH_k_CH_ALMST_EMPTY_THRSHOLD] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018028, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_RE_FETCH_READ_PTR] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018040, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018044, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_QOS] = {
	gsireg_construct_ee_n_gsi_ch_k_qos_v3_0, gsireg_parse_dummy,
	0x00018048, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_0] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0001804c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_1] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018050, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_2] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018054, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_3] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018058, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_4] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0001805c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_5] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018060, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_6] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018064, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_7] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018068, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_8] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0001806c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_SCRATCH_9] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00018070, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_0] = {
	gsireg_construct_ev_ch_k_cntxt_0_v3_0, gsireg_parse_ev_ch_k_cntxt_0_v3_0,
	0x00020000, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_1] = {
	gsireg_construct_ev_ch_k_cntxt_1_v3_0, gsireg_parse_dummy,
	0x00020004, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_2] = {
	gsireg_construct_ev_ch_k_cntxt_2, gsireg_parse_dummy,
	0x00020008, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_3] = {
	gsireg_construct_ev_ch_k_cntxt_3, gsireg_parse_dummy,
	0x0002000c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_4] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00020010, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_5] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00020014, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_6] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00020018, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_7] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0002001c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_8] = {
	gsireg_construct_ev_ch_k_cntxt_8, gsireg_parse_dummy,
	0x00020020, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_9] = {
	gsireg_construct_ev_ch_k_cntxt_9, gsireg_parse_dummy,
	0x00020024, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_10] = {
	gsireg_construct_ev_ch_k_cntxt_10, gsireg_parse_dummy,
	0x00020028, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_11] = {
	gsireg_construct_ev_ch_k_cntxt_11, gsireg_parse_dummy,
	0x0002002c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_12] = {
	gsireg_construct_ev_ch_k_cntxt_12, gsireg_parse_dummy,
	0x00020030, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_CNTXT_13] = {
	gsireg_construct_ev_ch_k_cntxt_13, gsireg_parse_dummy,
	0x00020034, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_SCRATCH_0] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00020048, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_SCRATCH_1] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0002004c, 0x12000, 0x80 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_DOORBELL_0] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00028000, 0x12000, 0x8 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_k_DOORBELL_1] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00028004, 0x12000, 0x8 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_DOORBELL_0] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00028800, 0x12000, 0x8 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_k_DOORBELL_1] = {
	gsireg_construct_ev_ch_k_doorbell_1, gsireg_parse_dummy,
	0x00028804, 0x12000, 0x8 },
	[GSI_VER_6_0][GSI_EE_n_GSI_STATUS] = {
	gsireg_construct_dummy, gsireg_parse_gsi_status,
	0x00029000, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_GSI_CH_CMD] = {
	gsireg_construct_ee_n_gsi_ch_cmd, gsireg_parse_dummy,
	0x00029008, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_EV_CH_CMD] = {
	gsireg_construct_ee_n_ev_ch_cmd, gsireg_parse_dummy,
	0x00029010, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_GSI_EE_GENERIC_CMD] = {
	gsireg_construct_gsi_ee_generic_cmd_v3_0, gsireg_parse_dummy,
	0x00029018, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_GSI_HW_PARAM_2] = {
	gsireg_construct_dummy, gsireg_parse_hw_param2_v3_0,
	0x00029040, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_GSI_HW_PARAM_4] = {
	gsireg_construct_dummy, gsireg_parse_hw_param4_v3_0,
	0x00029050, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_GSI_SW_VERSION] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029044, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_TYPE_IRQ] = {
	gsireg_construct_dummy, gsireg_parse_ctx_type_irq,
	0x00029080, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_TYPE_IRQ_MSK] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029088, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_GSI_CH_IRQ_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029090, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029094, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029098, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_EV_CH_IRQ_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0002909c, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_EV_CH_IRQ_MSK_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x000290a0, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_EV_CH_IRQ_CLR_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x000290a4, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_IEOB_IRQ_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x000290a8, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_IEOB_IRQ_MSK_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x000290ac, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SRC_IEOB_IRQ_CLR_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x000290b0, 0x12000, 0x24 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_GLOB_IRQ_STTS] = {
	gsireg_construct_dummy, gsireg_parse_cntxt_glob_irq_stts,
	0x00029200, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_GLOB_IRQ_EN] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029204, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_GLOB_IRQ_CLR] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029208, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_GSI_IRQ_STTS] = {
	gsireg_construct_dummy, gsireg_parse_cntxt_gsi_irq_stts,
	0x0002920c, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_GSI_IRQ_EN] = {
	gsireg_construct_cntxt_gsi_irq_en, gsireg_parse_dummy,
	0x00029210, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_GSI_IRQ_CLR] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029214, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_MSI_BASE_LSB] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029230, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_MSI_BASE_MSB] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029234, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_INTSET] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029220, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_ERROR_LOG] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029240, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_ERROR_LOG_CLR] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029244, 0x12000, 0 },
	[GSI_VER_6_0][GSI_EE_n_CNTXT_SCRATCH_0] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00029400, 0x12000, 0},
	[GSI_VER_6_0][GSI_INTER_EE_n_SRC_GSI_CH_IRQ_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00010018, 0x1000, 0x18 },
	[GSI_VER_6_0][GSI_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00010020, 0x1000, 0x18 },
	[GSI_VER_6_0][GSI_INTER_EE_n_SRC_EV_CH_IRQ_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x00010024, 0x1000, 0x18 },
	[GSI_VER_6_0][GSI_INTER_EE_n_SRC_EV_CH_IRQ_CLR_k] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
	0x0001002c, 0x1000, 0x18 },
	[GSI_VER_6_0][GSI_MAP_EE_n_CH_k_VP_TABLE] = {
	gsireg_construct_dummy, gsireg_parse_dummy,
