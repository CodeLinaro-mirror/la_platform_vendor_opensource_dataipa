...
#define GSI_V6_0_GSI_INST_RAM_n_MAXn 10303
#define GSI_V7_0_GSI_INST_RAM_n_MAXn GSI_INST_RAM_n_MAXn(GSI_V7_0_IRAM_SIZE, GSI_V7_0_NUM_PSIS)
...
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_MCS_STACK_OVRFLOW_BMSK 0xff000000
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_MCS_STACK_OVRFLOW_SHFT 0x18
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_CMD_FIFO_OVRFLOW_BMSK 0x10000
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_CMD_FIFO_OVRFLOW_SHFT 0x10
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_BUS_ERROR_BMSK 0x100
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_BUS_ERROR_SHFT 0x8
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_BREAK_POINT_BMSK 0xff
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_STTS_GSI_BREAK_POINT_SHFT 0x0
...
#define GSI_V3_0_EE_n_GSI_HW_PARAM_4_GSI_IRAM_PROTOCOL_CNT_BMSK 0xff00
#define GSI_V3_0_EE_n_GSI_HW_PARAM_4_GSI_IRAM_PROTOCOL_CNT_SHFT 0x8
...
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_MCS_STACK_OVRFLOW_BMSK 0xff000000
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_MCS_STACK_OVRFLOW_SHFT 0x18
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_CMD_FIFO_OVRFLOW_BMSK 0x10000
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_CMD_FIFO_OVRFLOW_SHFT 0x10
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_BUS_ERROR_BMSK 0x100
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_BUS_ERROR_SHFT 0x8
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_BREAK_POINT_BMSK 0xff
#define GSI_V7_0_EE_n_CNTXT_GSI_IRQ_EN_GSI_BREAK_POINT_SHFT 0x0

/**
 * GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE - valid for table0 and
 * table1 registers. table0 and table1 registers have the same
 * bitmasks and shift in ipa7.0.
 */
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ3_BMSK 0xff000000
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ3_SHFT 0x18
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ2_BMSK 0xff0000
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ2_SHFT 0x10
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ1_BMSK 0xff00
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ1_SHFT 0x8
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ0_BMSK 0xff
#define GSI_IRQ_2_MCS_MAPPING_ACCn_TABLE_VALID_MCS_FOR_IRQ0_SHFT 0x0

/**
 * GSI_MAX_TRE_TLV_n - an array of 4-bits elements, organized in
 * an array of registers, represent the max number of
 * TLVs that can be processed per NEW_RE IRQ for each channel.
 * Each register is 32 bit long, GSI_MAX_TRE_TLV_0[0:3] are for
 * channel id 0, GSI_MAX_TRE_TLV_0[28:31] are for channel id 7.
 * GSI_MAX_TRE_TLV_n[i:i+3] are for channel id
 * ((8 * n) + (i / 4)). GSI_MAX_TRE_TLV_n_MAXn is 9 for gsi7.0
 * meaning there are 7 such registers.
 */
#define GSI_MAX_TRE_TLV_n_MAXn 9
#define GSI_MAX_TRE_TLV_n_BITS_PER_ELEMENT 4
#define GSI_MAX_TRE_TLV_n_BMSK 0xffffffff
#define GSI_MAX_TRE_TLV_n_SHFT 0x0

/**
 * GSI_DEBUG_MUTEX_REGION_TYPE_01
 */
#define GSI_DEBUG_MUTEX_REGION_TYPE_01_REGION_TYPE_1_BMSK 0xffff0000
#define GSI_DEBUG_MUTEX_REGION_TYPE_01_REGION_TYPE_1_SHFT 0x10

/**
 * GSI_DEBUG_MUTEX_REGION_TYPE_23
 */
#define GSI_DEBUG_MUTEX_REGION_TYPE_23_REGION_TYPE_3_BMSK 0xffff0000
#define GSI_DEBUG_MUTEX_REGION_TYPE_23_REGION_TYPE_3_SHFT 0x10
#define GSI_DEBUG_MUTEX_REGION_TYPE_23_REGION_TYPE_2_BMSK 0xffff
#define GSI_DEBUG_MUTEX_REGION_TYPE_23_REGION_TYPE_2_SHFT 0
