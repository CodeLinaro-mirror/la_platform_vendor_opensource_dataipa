...
#define IPA_GROUP_MAX IPA_v6_0_GROUP_MAX
...
static struct ipa3_mem_partition ipa_6_0_mem_part = {
	...
	/* flt/rt v4/v6 addr are offsets from fnr_ofst base. */
	.stats_flt_v4_ofst = 0x0,
	.stats_flt_v4_size = 0x1000,
	.stats_flt_v6_ofst = 0x0,
	.stats_flt_v6_size = 0x1000,
	.stats_rt_v4_ofst = 0x1000,
	.stats_rt_v4_size = 0x1000,
	.stats_rt_v6_ofst = 0x1000,
	.stats_rt_v6_size = 0x1000,
...
u32 ipa3_get_max_num_pipes(void)
{
	...
	else if (ipa3_ctx->ipa_hw_type >= IPA_HW_v6_0)
