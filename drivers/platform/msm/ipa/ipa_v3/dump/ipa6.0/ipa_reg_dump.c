...
static struct map_src_dst_addr_s ipa_regs_to_save_array[] = {
	...
	GEN_SRC_DST_ADDR_MAP(IPA_STATE_ACL_1,
			     ipa.gen,
			     ipa_state_acl_1),
	GEN_SRC_DST_ADDR_MAP(IPA_STATE_ENCAPS,
			     ipa.gen,
			     ipa_state_encaps),
	GEN_SRC_DST_ADDR_MAP(IPA_STATE_DECAPS,
			     ipa.gen,
			     ipa_state_decaps),
	...
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP(IPA_ENDP_INIT_PROD_CFG_n,
					ipa_endp_init_prod_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP(IPA_ENDP_INIT_IPSEC_CFG_n,
					ipa_endp_init_ipsec_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP(IPA_ENDP_INIT_DRBIP_CFG_n,
	...
	GEN_SRC_DST_ADDR_MAP(GSI_DEBUG_PC_FROM_SW,
			     gsi.debug,
			     gsi_top_gsi_debug_pc_from_sw),
	...
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_EV_DB,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_ev_db),
	...
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_UC_GP_INT,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_uc_gp_int),
	...
	GEN_SRC_DST_ADDR_MAP(GSI_SHRAM_PTR_EE_SCRACH_BASE_ADDR,
			     gsi.debug.gsi_shram_ptrs,
			     gsi_top_gsi_shram_ptr_ee_scrach_base_addr),
	GEN_SRC_DST_ADDR_MAP(GSI_SHRAM_PTR_FUNC_STACK_BASE_ADDR,
			     gsi.debug.gsi_shram_ptrs,
			     gsi_top_gsi_shram_ptr_func_stack_base_addr),
...
void ipa_save_gsi_ver(void)
{
	...
	gsi_fw_ver = IPA_READ_1xVECTOR_REG(GSI_INST_RAM_0, 66);
...
static void ipa_reg_save_rsrc_cnts(void)
{
	...
	ipa_reg_save.rsrc_cnts.pcie.src.descriptor_list =
		src_rsrc_type_cnt_0_wout_ack_entry.def.rsrc_type_src_desc_list_cnt;
