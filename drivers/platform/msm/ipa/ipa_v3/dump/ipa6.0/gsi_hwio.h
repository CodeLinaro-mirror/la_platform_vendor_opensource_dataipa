...
/*----------------------------------------------------------------------------
 * MODULE: GSI_TOP_GSI_TOP_NO_XPU
 *--------------------------------------------------------------------------*/

#define GSI_TOP_GSI_TOP_NO_XPU_REG_BASE (IPA_WRAPPER_BASE      + 0x00000000)
#define GSI_TOP_GSI_TOP_NO_XPU_REG_BASE_PHYS (IPA_WRAPPER_BASE_PHYS + 0x00000000)
#define GSI_TOP_GSI_TOP_NO_XPU_REG_BASE_OFFS 0x00000000

/*----------------------------------------------------------------------------
 * MODULE: GSI
 *--------------------------------------------------------------------------*/

#define GSI_REG_BASE                                                                               (IPA_WRAPPER_BASE      + 0x00000000)
#define GSI_REG_BASE_PHYS                                                                          (IPA_WRAPPER_BASE_PHYS + 0x00000000)
#define GSI_REG_BASE_OFFS                                                                          0x00000000

#define HWIO_GSI_CFG_ADDR                                                                          (GSI_REG_BASE      + 0x00004000)
#define HWIO_GSI_CFG_PHYS                                                                          (GSI_REG_BASE_PHYS + 0x00004000)
#define HWIO_GSI_CFG_OFFS                                                                          (GSI_REG_BASE_OFFS + 0x00004000)
#define HWIO_GSI_CFG_RMSK                                                                               0xf39
...
#define HWIO_GSI_MANAGER_MCS_CODE_VER_ADDR                                                         (GSI_REG_BASE      + 0x00004008)
#define HWIO_GSI_MANAGER_MCS_CODE_VER_PHYS                                                         (GSI_REG_BASE_PHYS + 0x00004008)
#define HWIO_GSI_MANAGER_MCS_CODE_VER_OFFS                                                         (GSI_REG_BASE_OFFS + 0x00004008)
...
#define HWIO_GSI_ZEROS_ADDR                                                                        (GSI_REG_BASE      + 0x00004010)
#define HWIO_GSI_ZEROS_PHYS                                                                        (GSI_REG_BASE_PHYS + 0x00004010)
#define HWIO_GSI_ZEROS_OFFS                                                                        (GSI_REG_BASE_OFFS + 0x00004010)
...
#define HWIO_GSI_PERIPH_BASE_ADDR_LSB_ADDR                                                         (GSI_REG_BASE      + 0x00004018)
#define HWIO_GSI_PERIPH_BASE_ADDR_LSB_PHYS                                                         (GSI_REG_BASE_PHYS + 0x00004018)
#define HWIO_GSI_PERIPH_BASE_ADDR_LSB_OFFS                                                         (GSI_REG_BASE_OFFS + 0x00004018)
...
#define HWIO_GSI_PERIPH_BASE_ADDR_MSB_ADDR                                                         (GSI_REG_BASE      + 0x0000401c)
#define HWIO_GSI_PERIPH_BASE_ADDR_MSB_PHYS                                                         (GSI_REG_BASE_PHYS + 0x0000401c)
#define HWIO_GSI_PERIPH_BASE_ADDR_MSB_OFFS                                                         (GSI_REG_BASE_OFFS + 0x0000401c)
...
#define HWIO_GSI_CGC_CTRL_ADDR                                                                     (GSI_REG_BASE      + 0x00004020)
#define HWIO_GSI_CGC_CTRL_PHYS                                                                     (GSI_REG_BASE_PHYS + 0x00004020)
#define HWIO_GSI_CGC_CTRL_OFFS                                                                     (GSI_REG_BASE_OFFS + 0x00004020)
...
#define HWIO_GSI_MOQA_CFG_ADDR                                                                     (GSI_REG_BASE      + 0x00004030)
#define HWIO_GSI_MOQA_CFG_PHYS                                                                     (GSI_REG_BASE_PHYS + 0x00004030)
#define HWIO_GSI_MOQA_CFG_OFFS                                                                     (GSI_REG_BASE_OFFS + 0x00004030)
...
#define HWIO_GSI_REE_CFG_ADDR                                                                      (GSI_REG_BASE      + 0x00004038)
#define HWIO_GSI_REE_CFG_PHYS                                                                      (GSI_REG_BASE_PHYS + 0x00004038)
#define HWIO_GSI_REE_CFG_OFFS                                                                      (GSI_REG_BASE_OFFS + 0x00004038)
...
#define HWIO_GSI_PERIPH_PENDING_n_ADDR(n)                                                          (GSI_REG_BASE      + 0x00004060 + 0x4 * (n))
#define HWIO_GSI_PERIPH_PENDING_n_PHYS(n)                                                          (GSI_REG_BASE_PHYS + 0x00004060 + 0x4 * (n))
#define HWIO_GSI_PERIPH_PENDING_n_OFFS(n)                                                          (GSI_REG_BASE_OFFS + 0x00004060 + 0x4 * (n))
#define HWIO_GSI_PERIPH_PENDING_n_RMSK                                                             0xffffffff
#define HWIO_GSI_PERIPH_PENDING_n_MAXn                                                                      1
...
#define HWIO_GSI_MSI_CACHEATTR_ADDR                                                                (GSI_REG_BASE      + 0x00004080)
#define HWIO_GSI_MSI_CACHEATTR_PHYS                                                                (GSI_REG_BASE_PHYS + 0x00004080)
#define HWIO_GSI_MSI_CACHEATTR_OFFS                                                                (GSI_REG_BASE_OFFS + 0x00004080)
...
#define HWIO_GSI_EVENT_CACHEATTR_ADDR                                                              (GSI_REG_BASE      + 0x00004084)
#define HWIO_GSI_EVENT_CACHEATTR_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00004084)
#define HWIO_GSI_EVENT_CACHEATTR_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00004084)
...
#define HWIO_GSI_DATA_CACHEATTR_ADDR                                                               (GSI_REG_BASE      + 0x00004088)
#define HWIO_GSI_DATA_CACHEATTR_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00004088)
#define HWIO_GSI_DATA_CACHEATTR_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00004088)
...
#define HWIO_GSI_TRE_CACHEATTR_ADDR                                                                (GSI_REG_BASE      + 0x00004090)
#define HWIO_GSI_TRE_CACHEATTR_PHYS                                                                (GSI_REG_BASE_PHYS + 0x00004090)
#define HWIO_GSI_TRE_CACHEATTR_OFFS                                                                (GSI_REG_BASE_OFFS + 0x00004090)
...
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_LSB_ADDR                                                      (GSI_REG_BASE      + 0x000040a0)
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_LSB_PHYS                                                      (GSI_REG_BASE_PHYS + 0x000040a0)
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_LSB_OFFS                                                      (GSI_REG_BASE_OFFS + 0x000040a0)
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_LSB_RMSK                                                      0x3ffc3047
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_LSB_ATTR                                                             0x1
...
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_LSB_INT_END_INT_BMSK                                              0x3000
...
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_ADDR                                                      (GSI_REG_BASE      + 0x000040a4)
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_PHYS                                                      (GSI_REG_BASE_PHYS + 0x000040a4)
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_OFFS                                                      (GSI_REG_BASE_OFFS + 0x000040a4)
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_RMSK                                                       0xffc30c1
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_ATTR                                                             0x1
...
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_SDMA_INT_BMSK                                              0xf000000
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_SDMA_INT_SHFT                                                   0x18
...
#define HWIO_IC_DISABLE_CHNL_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                 0xc0
...
#define HWIO_IC_GEN_EVNT_BCK_PRS_LSB_ADDR                                                          (GSI_REG_BASE      + 0x000040a8)
#define HWIO_IC_GEN_EVNT_BCK_PRS_LSB_PHYS                                                          (GSI_REG_BASE_PHYS + 0x000040a8)
#define HWIO_IC_GEN_EVNT_BCK_PRS_LSB_OFFS                                                          (GSI_REG_BASE_OFFS + 0x000040a8)
#define HWIO_IC_GEN_EVNT_BCK_PRS_LSB_RMSK                                                          0x3ffc3047
#define HWIO_IC_GEN_EVNT_BCK_PRS_LSB_ATTR                                                                 0x1
...
#define HWIO_IC_GEN_EVNT_BCK_PRS_LSB_INT_END_INT_BMSK                                                  0x3000
...
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_ADDR                                                          (GSI_REG_BASE      + 0x000040ac)
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_PHYS                                                          (GSI_REG_BASE_PHYS + 0x000040ac)
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_OFFS                                                          (GSI_REG_BASE_OFFS + 0x000040ac)
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_RMSK                                                           0xffc30c1
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_ATTR                                                                 0x1
...
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_SDMA_INT_BMSK                                                  0xf000000
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_SDMA_INT_SHFT                                                       0x18
...
#define HWIO_IC_GEN_EVNT_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                     0xc0
...
#define HWIO_IC_GEN_INT_BCK_PRS_LSB_ADDR                                                           (GSI_REG_BASE      + 0x000040b0)
#define HWIO_IC_GEN_INT_BCK_PRS_LSB_PHYS                                                           (GSI_REG_BASE_PHYS + 0x000040b0)
#define HWIO_IC_GEN_INT_BCK_PRS_LSB_OFFS                                                           (GSI_REG_BASE_OFFS + 0x000040b0)
#define HWIO_IC_GEN_INT_BCK_PRS_LSB_RMSK                                                           0x3ffc3047
#define HWIO_IC_GEN_INT_BCK_PRS_LSB_ATTR                                                                  0x1
...
#define HWIO_IC_GEN_INT_BCK_PRS_LSB_INT_END_INT_BMSK                                                   0x3000
...
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_ADDR                                                           (GSI_REG_BASE      + 0x000040b4)
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_PHYS                                                           (GSI_REG_BASE_PHYS + 0x000040b4)
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_OFFS                                                           (GSI_REG_BASE_OFFS + 0x000040b4)
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_RMSK                                                            0xffc30c1
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_ATTR                                                                  0x1
...
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_SDMA_INT_BMSK                                                   0xf000000
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_SDMA_INT_SHFT                                                        0x18
...
#define HWIO_IC_GEN_INT_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                      0xc0
...
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_LSB_ADDR                                                      (GSI_REG_BASE      + 0x000040b8)
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_LSB_PHYS                                                      (GSI_REG_BASE_PHYS + 0x000040b8)
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_LSB_OFFS                                                      (GSI_REG_BASE_OFFS + 0x000040b8)
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_LSB_RMSK                                                      0x3ffc3047
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_LSB_ATTR                                                             0x1
...
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_LSB_INT_END_INT_BMSK                                              0x3000
...
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_ADDR                                                      (GSI_REG_BASE      + 0x000040bc)
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_PHYS                                                      (GSI_REG_BASE_PHYS + 0x000040bc)
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_OFFS                                                      (GSI_REG_BASE_OFFS + 0x000040bc)
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_RMSK                                                       0xffc30c1
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_ATTR                                                             0x1
...
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_SDMA_INT_BMSK                                              0xf000000
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_SDMA_INT_SHFT                                                   0x18
...
#define HWIO_IC_STOP_INT_MOD_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                 0xc0
...
#define HWIO_IC_PROCESS_DESC_BCK_PRS_LSB_ADDR                                                      (GSI_REG_BASE      + 0x000040c0)
#define HWIO_IC_PROCESS_DESC_BCK_PRS_LSB_PHYS                                                      (GSI_REG_BASE_PHYS + 0x000040c0)
#define HWIO_IC_PROCESS_DESC_BCK_PRS_LSB_OFFS                                                      (GSI_REG_BASE_OFFS + 0x000040c0)
#define HWIO_IC_PROCESS_DESC_BCK_PRS_LSB_RMSK                                                      0x3ffc3047
#define HWIO_IC_PROCESS_DESC_BCK_PRS_LSB_ATTR                                                             0x1
...
#define HWIO_IC_PROCESS_DESC_BCK_PRS_LSB_INT_END_INT_BMSK                                              0x3000
...
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_ADDR                                                      (GSI_REG_BASE      + 0x000040c4)
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_PHYS                                                      (GSI_REG_BASE_PHYS + 0x000040c4)
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_OFFS                                                      (GSI_REG_BASE_OFFS + 0x000040c4)
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_RMSK                                                       0xffc30c1
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_ATTR                                                             0x1
...
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_SDMA_INT_BMSK                                              0xf000000
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_SDMA_INT_SHFT                                                   0x18
...
#define HWIO_IC_PROCESS_DESC_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                 0xc0
...
#define HWIO_IC_TLV_STOP_BCK_PRS_LSB_ADDR                                                          (GSI_REG_BASE      + 0x000040c8)
#define HWIO_IC_TLV_STOP_BCK_PRS_LSB_PHYS                                                          (GSI_REG_BASE_PHYS + 0x000040c8)
#define HWIO_IC_TLV_STOP_BCK_PRS_LSB_OFFS                                                          (GSI_REG_BASE_OFFS + 0x000040c8)
#define HWIO_IC_TLV_STOP_BCK_PRS_LSB_RMSK                                                          0x3ffc3047
#define HWIO_IC_TLV_STOP_BCK_PRS_LSB_ATTR                                                                 0x1
...
#define HWIO_IC_TLV_STOP_BCK_PRS_LSB_INT_END_INT_BMSK                                                  0x3000
...
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_ADDR                                                          (GSI_REG_BASE      + 0x000040cc)
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_PHYS                                                          (GSI_REG_BASE_PHYS + 0x000040cc)
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_OFFS                                                          (GSI_REG_BASE_OFFS + 0x000040cc)
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_RMSK                                                           0xffc30c1
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_ATTR                                                                 0x1
...
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_SDMA_INT_BMSK                                                  0xf000000
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_SDMA_INT_SHFT                                                       0x18
...
#define HWIO_IC_TLV_STOP_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                     0xc0
...
#define HWIO_IC_TLV_RESET_BCK_PRS_LSB_ADDR                                                         (GSI_REG_BASE      + 0x000040d0)
#define HWIO_IC_TLV_RESET_BCK_PRS_LSB_PHYS                                                         (GSI_REG_BASE_PHYS + 0x000040d0)
#define HWIO_IC_TLV_RESET_BCK_PRS_LSB_OFFS                                                         (GSI_REG_BASE_OFFS + 0x000040d0)
#define HWIO_IC_TLV_RESET_BCK_PRS_LSB_RMSK                                                         0x3ffc3047
#define HWIO_IC_TLV_RESET_BCK_PRS_LSB_ATTR                                                                0x1
...
#define HWIO_IC_TLV_RESET_BCK_PRS_LSB_INT_END_INT_BMSK                                                 0x3000
...
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_ADDR                                                         (GSI_REG_BASE      + 0x000040d4)
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_PHYS                                                         (GSI_REG_BASE_PHYS + 0x000040d4)
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_OFFS                                                         (GSI_REG_BASE_OFFS + 0x000040d4)
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_RMSK                                                          0xffc30c1
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_ATTR                                                                0x1
...
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_SDMA_INT_BMSK                                                 0xf000000
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_SDMA_INT_SHFT                                                      0x18
...
#define HWIO_IC_TLV_RESET_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                    0xc0
...
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_LSB_ADDR                                                       (GSI_REG_BASE      + 0x000040d8)
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_LSB_PHYS                                                       (GSI_REG_BASE_PHYS + 0x000040d8)
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_LSB_OFFS                                                       (GSI_REG_BASE_OFFS + 0x000040d8)
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_LSB_RMSK                                                       0x3ffc3047
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_LSB_ATTR                                                              0x1
...
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_LSB_INT_END_INT_BMSK                                               0x3000
...
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_ADDR                                                       (GSI_REG_BASE      + 0x000040dc)
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_PHYS                                                       (GSI_REG_BASE_PHYS + 0x000040dc)
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_OFFS                                                       (GSI_REG_BASE_OFFS + 0x000040dc)
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_RMSK                                                        0xffc30c1
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_ATTR                                                              0x1
...
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_SDMA_INT_BMSK                                               0xf000000
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_SDMA_INT_SHFT                                                    0x18
...
#define HWIO_IC_RGSTR_TIMER_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                  0xc0
...
#define HWIO_IC_READ_BCK_PRS_LSB_ADDR                                                              (GSI_REG_BASE      + 0x000040e0)
#define HWIO_IC_READ_BCK_PRS_LSB_PHYS                                                              (GSI_REG_BASE_PHYS + 0x000040e0)
#define HWIO_IC_READ_BCK_PRS_LSB_OFFS                                                              (GSI_REG_BASE_OFFS + 0x000040e0)
#define HWIO_IC_READ_BCK_PRS_LSB_RMSK                                                              0x3ffc3047
#define HWIO_IC_READ_BCK_PRS_LSB_ATTR                                                                     0x1
...
#define HWIO_IC_READ_BCK_PRS_LSB_INT_END_INT_BMSK                                                      0x3000
...
#define HWIO_IC_READ_BCK_PRS_MSB_ADDR                                                              (GSI_REG_BASE      + 0x000040e4)
#define HWIO_IC_READ_BCK_PRS_MSB_PHYS                                                              (GSI_REG_BASE_PHYS + 0x000040e4)
#define HWIO_IC_READ_BCK_PRS_MSB_OFFS                                                              (GSI_REG_BASE_OFFS + 0x000040e4)
#define HWIO_IC_READ_BCK_PRS_MSB_RMSK                                                               0xffc30c1
#define HWIO_IC_READ_BCK_PRS_MSB_ATTR                                                                     0x1
...
#define HWIO_IC_READ_BCK_PRS_MSB_SDMA_INT_BMSK                                                      0xf000000
#define HWIO_IC_READ_BCK_PRS_MSB_SDMA_INT_SHFT                                                           0x18
...
#define HWIO_IC_READ_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                         0xc0
...
#define HWIO_IC_WRITE_BCK_PRS_LSB_ADDR                                                             (GSI_REG_BASE      + 0x000040e8)
#define HWIO_IC_WRITE_BCK_PRS_LSB_PHYS                                                             (GSI_REG_BASE_PHYS + 0x000040e8)
#define HWIO_IC_WRITE_BCK_PRS_LSB_OFFS                                                             (GSI_REG_BASE_OFFS + 0x000040e8)
#define HWIO_IC_WRITE_BCK_PRS_LSB_RMSK                                                             0x3ffc3047
#define HWIO_IC_WRITE_BCK_PRS_LSB_ATTR                                                                    0x1
...
#define HWIO_IC_WRITE_BCK_PRS_LSB_INT_END_INT_BMSK                                                     0x3000
...
#define HWIO_IC_WRITE_BCK_PRS_MSB_ADDR                                                             (GSI_REG_BASE      + 0x000040ec)
#define HWIO_IC_WRITE_BCK_PRS_MSB_PHYS                                                             (GSI_REG_BASE_PHYS + 0x000040ec)
#define HWIO_IC_WRITE_BCK_PRS_MSB_OFFS                                                             (GSI_REG_BASE_OFFS + 0x000040ec)
#define HWIO_IC_WRITE_BCK_PRS_MSB_RMSK                                                              0xffc30c1
#define HWIO_IC_WRITE_BCK_PRS_MSB_ATTR                                                                    0x1
...
#define HWIO_IC_WRITE_BCK_PRS_MSB_SDMA_INT_BMSK                                                     0xf000000
#define HWIO_IC_WRITE_BCK_PRS_MSB_SDMA_INT_SHFT                                                          0x18
...
#define HWIO_IC_WRITE_BCK_PRS_MSB_DB_ENG_INT_BMSK                                                        0xc0
...
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_LSB_ADDR                                                   (GSI_REG_BASE      + 0x000040f0)
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_LSB_PHYS                                                   (GSI_REG_BASE_PHYS + 0x000040f0)
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_LSB_OFFS                                                   (GSI_REG_BASE_OFFS + 0x000040f0)
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_LSB_RMSK                                                   0x3ffc3047
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_LSB_ATTR                                                          0x1
...
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_LSB_INT_END_INT_BMSK                                           0x3000
...
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_ADDR                                                   (GSI_REG_BASE      + 0x000040f4)
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_PHYS                                                   (GSI_REG_BASE_PHYS + 0x000040f4)
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_OFFS                                                   (GSI_REG_BASE_OFFS + 0x000040f4)
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_RMSK                                                    0xffc30c1
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_ATTR                                                          0x1
...
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_SDMA_INT_BMSK                                           0xf000000
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_SDMA_INT_SHFT                                                0x18
...
#define HWIO_IC_UCONTROLLER_GPR_BCK_PRS_MSB_DB_ENG_INT_BMSK                                              0xc0
...
#define HWIO_IC_INT_WEIGHT_REE_ADDR                                                                (GSI_REG_BASE      + 0x00004100)
#define HWIO_IC_INT_WEIGHT_REE_PHYS                                                                (GSI_REG_BASE_PHYS + 0x00004100)
#define HWIO_IC_INT_WEIGHT_REE_OFFS                                                                (GSI_REG_BASE_OFFS + 0x00004100)
...
#define HWIO_IC_INT_WEIGHT_EVT_ENG_ADDR                                                            (GSI_REG_BASE      + 0x00004104)
#define HWIO_IC_INT_WEIGHT_EVT_ENG_PHYS                                                            (GSI_REG_BASE_PHYS + 0x00004104)
#define HWIO_IC_INT_WEIGHT_EVT_ENG_OFFS                                                            (GSI_REG_BASE_OFFS + 0x00004104)
...
#define HWIO_IC_INT_WEIGHT_INT_ENG_ADDR                                                            (GSI_REG_BASE      + 0x00004108)
#define HWIO_IC_INT_WEIGHT_INT_ENG_PHYS                                                            (GSI_REG_BASE_PHYS + 0x00004108)
#define HWIO_IC_INT_WEIGHT_INT_ENG_OFFS                                                            (GSI_REG_BASE_OFFS + 0x00004108)
...
#define HWIO_IC_INT_WEIGHT_CSR_ADDR                                                                (GSI_REG_BASE      + 0x0000410c)
#define HWIO_IC_INT_WEIGHT_CSR_PHYS                                                                (GSI_REG_BASE_PHYS + 0x0000410c)
#define HWIO_IC_INT_WEIGHT_CSR_OFFS                                                                (GSI_REG_BASE_OFFS + 0x0000410c)
...
#define HWIO_IC_INT_WEIGHT_TLV_ENG_ADDR                                                            (GSI_REG_BASE      + 0x00004110)
#define HWIO_IC_INT_WEIGHT_TLV_ENG_PHYS                                                            (GSI_REG_BASE_PHYS + 0x00004110)
#define HWIO_IC_INT_WEIGHT_TLV_ENG_OFFS                                                            (GSI_REG_BASE_OFFS + 0x00004110)
...
#define HWIO_IC_INT_WEIGHT_TIMER_ENG_ADDR                                                          (GSI_REG_BASE      + 0x00004114)
#define HWIO_IC_INT_WEIGHT_TIMER_ENG_PHYS                                                          (GSI_REG_BASE_PHYS + 0x00004114)
#define HWIO_IC_INT_WEIGHT_TIMER_ENG_OFFS                                                          (GSI_REG_BASE_OFFS + 0x00004114)
...
#define HWIO_IC_INT_WEIGHT_DB_ENG_ADDR                                                             (GSI_REG_BASE      + 0x00004118)
#define HWIO_IC_INT_WEIGHT_DB_ENG_PHYS                                                             (GSI_REG_BASE_PHYS + 0x00004118)
#define HWIO_IC_INT_WEIGHT_DB_ENG_OFFS                                                             (GSI_REG_BASE_OFFS + 0x00004118)
...
#define HWIO_IC_INT_WEIGHT_RD_WR_ENG_ADDR                                                          (GSI_REG_BASE      + 0x0000411c)
#define HWIO_IC_INT_WEIGHT_RD_WR_ENG_PHYS                                                          (GSI_REG_BASE_PHYS + 0x0000411c)
#define HWIO_IC_INT_WEIGHT_RD_WR_ENG_OFFS                                                          (GSI_REG_BASE_OFFS + 0x0000411c)
...
#define HWIO_IC_INT_WEIGHT_UCONTROLLER_ENG_ADDR                                                    (GSI_REG_BASE      + 0x00004120)
#define HWIO_IC_INT_WEIGHT_UCONTROLLER_ENG_PHYS                                                    (GSI_REG_BASE_PHYS + 0x00004120)
#define HWIO_IC_INT_WEIGHT_UCONTROLLER_ENG_OFFS                                                    (GSI_REG_BASE_OFFS + 0x00004120)
...
#define HWIO_LOW_LATENCY_ARB_WEIGHT_ADDR                                                           (GSI_REG_BASE      + 0x00004128)
#define HWIO_LOW_LATENCY_ARB_WEIGHT_PHYS                                                           (GSI_REG_BASE_PHYS + 0x00004128)
#define HWIO_LOW_LATENCY_ARB_WEIGHT_OFFS                                                           (GSI_REG_BASE_OFFS + 0x00004128)
...
#define HWIO_IC_INT_WEIGHT_SDMA_ADDR                                                               (GSI_REG_BASE      + 0x00004124)
#define HWIO_IC_INT_WEIGHT_SDMA_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00004124)
#define HWIO_IC_INT_WEIGHT_SDMA_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00004124)
...
#define HWIO_GSI_SDMA_CFG_ADDR                                                                     (GSI_REG_BASE      + 0x0000403c)
#define HWIO_GSI_SDMA_CFG_PHYS                                                                     (GSI_REG_BASE_PHYS + 0x0000403c)
#define HWIO_GSI_SDMA_CFG_OFFS                                                                     (GSI_REG_BASE_OFFS + 0x0000403c)
...
#define HWIO_GSI_SDMA_CACHEATTR_ADDR                                                               (GSI_REG_BASE      + 0x00004094)
#define HWIO_GSI_SDMA_CACHEATTR_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00004094)
#define HWIO_GSI_SDMA_CACHEATTR_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00004094)
...
#define HWIO_GSI_SDMA_SG_IOVEC_LSB_n_ADDR(n)                                                       (GSI_REG_BASE      + 0x00004140 + 0x8 * (n))
#define HWIO_GSI_SDMA_SG_IOVEC_LSB_n_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00004140 + 0x8 * (n))
#define HWIO_GSI_SDMA_SG_IOVEC_LSB_n_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00004140 + 0x8 * (n))
...
#define HWIO_GSI_SDMA_SG_IOVEC_MSB_n_ADDR(n)                                                       (GSI_REG_BASE      + 0x00004144 + 0x8 * (n))
#define HWIO_GSI_SDMA_SG_IOVEC_MSB_n_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00004144 + 0x8 * (n))
#define HWIO_GSI_SDMA_SG_IOVEC_MSB_n_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00004144 + 0x8 * (n))
...
#define HWIO_GSI_MANAGER_EE_QOS_n_ADDR(n)                                                          (GSI_REG_BASE      + 0x00004300 + 0x4 * (n))
#define HWIO_GSI_MANAGER_EE_QOS_n_PHYS(n)                                                          (GSI_REG_BASE_PHYS + 0x00004300 + 0x4 * (n))
#define HWIO_GSI_MANAGER_EE_QOS_n_OFFS(n)                                                          (GSI_REG_BASE_OFFS + 0x00004300 + 0x4 * (n))
...
#define HWIO_GSI_SHRAM_PTR_CH_CNTXT_BASE_ADDR_ADDR                                                 (GSI_REG_BASE      + 0x00004200)
#define HWIO_GSI_SHRAM_PTR_CH_CNTXT_BASE_ADDR_PHYS                                                 (GSI_REG_BASE_PHYS + 0x00004200)
#define HWIO_GSI_SHRAM_PTR_CH_CNTXT_BASE_ADDR_OFFS                                                 (GSI_REG_BASE_OFFS + 0x00004200)
...
#define HWIO_GSI_SHRAM_PTR_EV_CNTXT_BASE_ADDR_ADDR                                                 (GSI_REG_BASE      + 0x00004204)
#define HWIO_GSI_SHRAM_PTR_EV_CNTXT_BASE_ADDR_PHYS                                                 (GSI_REG_BASE_PHYS + 0x00004204)
#define HWIO_GSI_SHRAM_PTR_EV_CNTXT_BASE_ADDR_OFFS                                                 (GSI_REG_BASE_OFFS + 0x00004204)
...
#define HWIO_GSI_SHRAM_PTR_RE_STORAGE_BASE_ADDR_ADDR                                               (GSI_REG_BASE      + 0x00004208)
#define HWIO_GSI_SHRAM_PTR_RE_STORAGE_BASE_ADDR_PHYS                                               (GSI_REG_BASE_PHYS + 0x00004208)
#define HWIO_GSI_SHRAM_PTR_RE_STORAGE_BASE_ADDR_OFFS                                               (GSI_REG_BASE_OFFS + 0x00004208)
...
#define HWIO_GSI_SHRAM_PTR_RE_ESC_BUF_BASE_ADDR_ADDR                                               (GSI_REG_BASE      + 0x0000420c)
#define HWIO_GSI_SHRAM_PTR_RE_ESC_BUF_BASE_ADDR_PHYS                                               (GSI_REG_BASE_PHYS + 0x0000420c)
#define HWIO_GSI_SHRAM_PTR_RE_ESC_BUF_BASE_ADDR_OFFS                                               (GSI_REG_BASE_OFFS + 0x0000420c)
...
#define HWIO_GSI_SHRAM_PTR_EE_SCRACH_BASE_ADDR_ADDR                                                (GSI_REG_BASE      + 0x00004240)
#define HWIO_GSI_SHRAM_PTR_EE_SCRACH_BASE_ADDR_PHYS                                                (GSI_REG_BASE_PHYS + 0x00004240)
#define HWIO_GSI_SHRAM_PTR_EE_SCRACH_BASE_ADDR_OFFS                                                (GSI_REG_BASE_OFFS + 0x00004240)
...
#define HWIO_GSI_SHRAM_PTR_FUNC_STACK_BASE_ADDR_ADDR                                               (GSI_REG_BASE      + 0x00004244)
#define HWIO_GSI_SHRAM_PTR_FUNC_STACK_BASE_ADDR_PHYS                                               (GSI_REG_BASE_PHYS + 0x00004244)
#define HWIO_GSI_SHRAM_PTR_FUNC_STACK_BASE_ADDR_OFFS                                               (GSI_REG_BASE_OFFS + 0x00004244)
...
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH_BASE_ADDR_ADDR                                              (GSI_REG_BASE      + 0x00004210)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH_BASE_ADDR_PHYS                                              (GSI_REG_BASE_PHYS + 0x00004210)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH_BASE_ADDR_OFFS                                              (GSI_REG_BASE_OFFS + 0x00004210)
...
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH1_BASE_ADDR_ADDR                                             (GSI_REG_BASE      + 0x00004214)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH1_BASE_ADDR_PHYS                                             (GSI_REG_BASE_PHYS + 0x00004214)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH1_BASE_ADDR_OFFS                                             (GSI_REG_BASE_OFFS + 0x00004214)
...
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH2_BASE_ADDR_ADDR                                             (GSI_REG_BASE      + 0x00004218)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH2_BASE_ADDR_PHYS                                             (GSI_REG_BASE_PHYS + 0x00004218)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH2_BASE_ADDR_OFFS                                             (GSI_REG_BASE_OFFS + 0x00004218)
...
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH3_BASE_ADDR_ADDR                                             (GSI_REG_BASE      + 0x0000421c)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH3_BASE_ADDR_PHYS                                             (GSI_REG_BASE_PHYS + 0x0000421c)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH3_BASE_ADDR_OFFS                                             (GSI_REG_BASE_OFFS + 0x0000421c)
...
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH4_BASE_ADDR_ADDR                                             (GSI_REG_BASE      + 0x00004220)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH4_BASE_ADDR_PHYS                                             (GSI_REG_BASE_PHYS + 0x00004220)
#define HWIO_GSI_SHRAM_PTR_MCS_SCRATCH4_BASE_ADDR_OFFS                                             (GSI_REG_BASE_OFFS + 0x00004220)
...
#define HWIO_GSI_SHRAM_PTR_CH_VP_TRANS_TABLE_BASE_ADDR_ADDR                                        (GSI_REG_BASE      + 0x00004254)
#define HWIO_GSI_SHRAM_PTR_CH_VP_TRANS_TABLE_BASE_ADDR_PHYS                                        (GSI_REG_BASE_PHYS + 0x00004254)
#define HWIO_GSI_SHRAM_PTR_CH_VP_TRANS_TABLE_BASE_ADDR_OFFS                                        (GSI_REG_BASE_OFFS + 0x00004254)
...
#define HWIO_GSI_SHRAM_PTR_EV_VP_TRANS_TABLE_BASE_ADDR_ADDR                                        (GSI_REG_BASE      + 0x00004258)
#define HWIO_GSI_SHRAM_PTR_EV_VP_TRANS_TABLE_BASE_ADDR_PHYS                                        (GSI_REG_BASE_PHYS + 0x00004258)
#define HWIO_GSI_SHRAM_PTR_EV_VP_TRANS_TABLE_BASE_ADDR_OFFS                                        (GSI_REG_BASE_OFFS + 0x00004258)
...
#define HWIO_GSI_SHRAM_PTR_USER_INFO_DATA_BASE_ADDR_ADDR                                           (GSI_REG_BASE      + 0x0000425c)
#define HWIO_GSI_SHRAM_PTR_USER_INFO_DATA_BASE_ADDR_PHYS                                           (GSI_REG_BASE_PHYS + 0x0000425c)
#define HWIO_GSI_SHRAM_PTR_USER_INFO_DATA_BASE_ADDR_OFFS                                           (GSI_REG_BASE_OFFS + 0x0000425c)
...
#define HWIO_GSI_SHRAM_PTR_EE_CMD_FIFO_BASE_ADDR_ADDR                                              (GSI_REG_BASE      + 0x00004260)
#define HWIO_GSI_SHRAM_PTR_EE_CMD_FIFO_BASE_ADDR_PHYS                                              (GSI_REG_BASE_PHYS + 0x00004260)
#define HWIO_GSI_SHRAM_PTR_EE_CMD_FIFO_BASE_ADDR_OFFS                                              (GSI_REG_BASE_OFFS + 0x00004260)
...
#define HWIO_GSI_SHRAM_PTR_CH_CMD_FIFO_BASE_ADDR_ADDR                                              (GSI_REG_BASE      + 0x00004264)
#define HWIO_GSI_SHRAM_PTR_CH_CMD_FIFO_BASE_ADDR_PHYS                                              (GSI_REG_BASE_PHYS + 0x00004264)
#define HWIO_GSI_SHRAM_PTR_CH_CMD_FIFO_BASE_ADDR_OFFS                                              (GSI_REG_BASE_OFFS + 0x00004264)
...
#define HWIO_GSI_SHRAM_PTR_EVE_ED_STORAGE_BASE_ADDR_ADDR                                           (GSI_REG_BASE      + 0x00004268)
#define HWIO_GSI_SHRAM_PTR_EVE_ED_STORAGE_BASE_ADDR_PHYS                                           (GSI_REG_BASE_PHYS + 0x00004268)
#define HWIO_GSI_SHRAM_PTR_EVE_ED_STORAGE_BASE_ADDR_OFFS                                           (GSI_REG_BASE_OFFS + 0x00004268)
...
#define HWIO_GSI_IRAM_PTR_CH_CMD_ADDR                                                              (GSI_REG_BASE      + 0x00004400)
#define HWIO_GSI_IRAM_PTR_CH_CMD_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00004400)
#define HWIO_GSI_IRAM_PTR_CH_CMD_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00004400)
...
#define HWIO_GSI_IRAM_PTR_EE_GENERIC_CMD_ADDR                                                      (GSI_REG_BASE      + 0x00004404)
#define HWIO_GSI_IRAM_PTR_EE_GENERIC_CMD_PHYS                                                      (GSI_REG_BASE_PHYS + 0x00004404)
#define HWIO_GSI_IRAM_PTR_EE_GENERIC_CMD_OFFS                                                      (GSI_REG_BASE_OFFS + 0x00004404)
...
#define HWIO_GSI_IRAM_PTR_TLV_CH_NOT_FULL_ADDR                                                     (GSI_REG_BASE      + 0x00004408)
#define HWIO_GSI_IRAM_PTR_TLV_CH_NOT_FULL_PHYS                                                     (GSI_REG_BASE_PHYS + 0x00004408)
#define HWIO_GSI_IRAM_PTR_TLV_CH_NOT_FULL_OFFS                                                     (GSI_REG_BASE_OFFS + 0x00004408)
...
#define HWIO_GSI_IRAM_PTR_MSI_DB_ADDR                                                              (GSI_REG_BASE      + 0x00004414)
#define HWIO_GSI_IRAM_PTR_MSI_DB_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00004414)
#define HWIO_GSI_IRAM_PTR_MSI_DB_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00004414)
...
#define HWIO_GSI_IRAM_PTR_CH_DB_ADDR                                                               (GSI_REG_BASE      + 0x00004418)
#define HWIO_GSI_IRAM_PTR_CH_DB_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00004418)
#define HWIO_GSI_IRAM_PTR_CH_DB_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00004418)
...
#define HWIO_GSI_IRAM_PTR_EV_DB_ADDR                                                               (GSI_REG_BASE      + 0x0000441c)
#define HWIO_GSI_IRAM_PTR_EV_DB_PHYS                                                               (GSI_REG_BASE_PHYS + 0x0000441c)
#define HWIO_GSI_IRAM_PTR_EV_DB_OFFS                                                               (GSI_REG_BASE_OFFS + 0x0000441c)
...
#define HWIO_GSI_IRAM_PTR_NEW_RE_ADDR                                                              (GSI_REG_BASE      + 0x00004420)
#define HWIO_GSI_IRAM_PTR_NEW_RE_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00004420)
#define HWIO_GSI_IRAM_PTR_NEW_RE_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00004420)
...
#define HWIO_GSI_IRAM_PTR_CH_DIS_COMP_ADDR                                                         (GSI_REG_BASE      + 0x00004424)
#define HWIO_GSI_IRAM_PTR_CH_DIS_COMP_PHYS                                                         (GSI_REG_BASE_PHYS + 0x00004424)
#define HWIO_GSI_IRAM_PTR_CH_DIS_COMP_OFFS                                                         (GSI_REG_BASE_OFFS + 0x00004424)
...
#define HWIO_GSI_IRAM_PTR_CH_EMPTY_ADDR                                                            (GSI_REG_BASE      + 0x00004428)
#define HWIO_GSI_IRAM_PTR_CH_EMPTY_PHYS                                                            (GSI_REG_BASE_PHYS + 0x00004428)
#define HWIO_GSI_IRAM_PTR_CH_EMPTY_OFFS                                                            (GSI_REG_BASE_OFFS + 0x00004428)
...
#define HWIO_GSI_IRAM_PTR_EVENT_GEN_COMP_ADDR                                                      (GSI_REG_BASE      + 0x0000442c)
#define HWIO_GSI_IRAM_PTR_EVENT_GEN_COMP_PHYS                                                      (GSI_REG_BASE_PHYS + 0x0000442c)
#define HWIO_GSI_IRAM_PTR_EVENT_GEN_COMP_OFFS                                                      (GSI_REG_BASE_OFFS + 0x0000442c)
...
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_0_ADDR                                                  (GSI_REG_BASE      + 0x00004430)
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_0_PHYS                                                  (GSI_REG_BASE_PHYS + 0x00004430)
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_0_OFFS                                                  (GSI_REG_BASE_OFFS + 0x00004430)
...
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_2_ADDR                                                  (GSI_REG_BASE      + 0x00004434)
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_2_PHYS                                                  (GSI_REG_BASE_PHYS + 0x00004434)
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_2_OFFS                                                  (GSI_REG_BASE_OFFS + 0x00004434)
...
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_1_ADDR                                                  (GSI_REG_BASE      + 0x00004438)
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_1_PHYS                                                  (GSI_REG_BASE_PHYS + 0x00004438)
#define HWIO_GSI_IRAM_PTR_PERIPH_IF_TLV_IN_1_OFFS                                                  (GSI_REG_BASE_OFFS + 0x00004438)
...
#define HWIO_GSI_IRAM_PTR_TIMER_EXPIRED_ADDR                                                       (GSI_REG_BASE      + 0x0000443c)
#define HWIO_GSI_IRAM_PTR_TIMER_EXPIRED_PHYS                                                       (GSI_REG_BASE_PHYS + 0x0000443c)
#define HWIO_GSI_IRAM_PTR_TIMER_EXPIRED_OFFS                                                       (GSI_REG_BASE_OFFS + 0x0000443c)
...
#define HWIO_GSI_IRAM_PTR_WRITE_ENG_COMP_ADDR                                                      (GSI_REG_BASE      + 0x00004440)
#define HWIO_GSI_IRAM_PTR_WRITE_ENG_COMP_PHYS                                                      (GSI_REG_BASE_PHYS + 0x00004440)
#define HWIO_GSI_IRAM_PTR_WRITE_ENG_COMP_OFFS                                                      (GSI_REG_BASE_OFFS + 0x00004440)
...
#define HWIO_GSI_IRAM_PTR_READ_ENG_COMP_ADDR                                                       (GSI_REG_BASE      + 0x00004444)
#define HWIO_GSI_IRAM_PTR_READ_ENG_COMP_PHYS                                                       (GSI_REG_BASE_PHYS + 0x00004444)
#define HWIO_GSI_IRAM_PTR_READ_ENG_COMP_OFFS                                                       (GSI_REG_BASE_OFFS + 0x00004444)
...
#define HWIO_GSI_IRAM_PTR_UC_GP_INT_ADDR                                                           (GSI_REG_BASE      + 0x00004448)
#define HWIO_GSI_IRAM_PTR_UC_GP_INT_PHYS                                                           (GSI_REG_BASE_PHYS + 0x00004448)
#define HWIO_GSI_IRAM_PTR_UC_GP_INT_OFFS                                                           (GSI_REG_BASE_OFFS + 0x00004448)
...
#define HWIO_GSI_IRAM_PTR_INT_MOD_STOPED_ADDR                                                      (GSI_REG_BASE      + 0x0000444c)
#define HWIO_GSI_IRAM_PTR_INT_MOD_STOPED_PHYS                                                      (GSI_REG_BASE_PHYS + 0x0000444c)
#define HWIO_GSI_IRAM_PTR_INT_MOD_STOPED_OFFS                                                      (GSI_REG_BASE_OFFS + 0x0000444c)
...
#define HWIO_GSI_IRAM_PTR_SDMA_INT_n_ADDR(n)                                                       (GSI_REG_BASE      + 0x00004450 + 0x4 * (n))
#define HWIO_GSI_IRAM_PTR_SDMA_INT_n_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00004450 + 0x4 * (n))
#define HWIO_GSI_IRAM_PTR_SDMA_INT_n_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00004450 + 0x4 * (n))
#define HWIO_GSI_IRAM_PTR_SDMA_INT_n_RMSK                                                               0xfff
...
#define HWIO_GSI_IRAM_PTR_SDMA_INT_n_IRAM_PTR_BMSK                                                      0xfff
#define HWIO_GSI_IRAM_PTR_SDMA_INT_n_IRAM_PTR_SHFT                                                        0x0

#define HWIO_GSI_IRAM_PTR_INT_NOTIFY_MCS_ADDR                                                      (GSI_REG_BASE      + 0x00004470)
#define HWIO_GSI_IRAM_PTR_INT_NOTIFY_MCS_PHYS                                                      (GSI_REG_BASE_PHYS + 0x00004470)
#define HWIO_GSI_IRAM_PTR_INT_NOTIFY_MCS_OFFS                                                      (GSI_REG_BASE_OFFS + 0x00004470)
...
*/
#define HWIO_GSI_INST_RAM_0_ADDR_n(n)                                                              (GSI_REG_BASE      + 0x000a8000 + 0x4 * (n))
#define HWIO_GSI_INST_RAM_0_ADDR                                                                   (GSI_REG_BASE      + 0x000a8000)
#define HWIO_GSI_INST_RAM_0_PHYS                                                                   (GSI_REG_BASE_PHYS + 0x000a8000)
#define HWIO_GSI_INST_RAM_0_OFFS                                                                   (GSI_REG_BASE_OFFS + 0x000a8000)
...
*/
#define HWIO_GSI_SHRAM_0_ADDR_n(n)                                                                 (GSI_REG_BASE      + 0x00006000 + 0x4 * (n))
#define HWIO_GSI_SHRAM_0_ADDR                                                                      (GSI_REG_BASE      + 0x00006000)
#define HWIO_GSI_SHRAM_0_PHYS                                                                      (GSI_REG_BASE_PHYS + 0x00006000)
#define HWIO_GSI_SHRAM_0_OFFS                                                                      (GSI_REG_BASE_OFFS + 0x00006000)
...
#define HWIO_GSI_SHRAM_0_IN          \
        in_dword_masked(HWIO_GSI_SHRAM_0_ADDR, HWIO_GSI_SHRAM_0_RMSK, HWIO_GSI_SHRAM_0_ATTR)
#define HWIO_GSI_SHRAM_0_INM(m)      \
        in_dword_masked(HWIO_GSI_SHRAM_0_ADDR, m, HWIO_GSI_SHRAM_0_ATTR)
...
#define HWIO_GSI_MAP_EE_n_CH_k_VP_TABLE_ADDR(n,k)                                                  (GSI_REG_BASE      + 0x0000d000 + 0x400 * (n) + 0x4 * (k))
#define HWIO_GSI_MAP_EE_n_CH_k_VP_TABLE_PHYS(n,k)                                                  (GSI_REG_BASE_PHYS + 0x0000d000 + 0x400 * (n) + 0x4 * (k))
#define HWIO_GSI_MAP_EE_n_CH_k_VP_TABLE_OFFS(n,k)                                                  (GSI_REG_BASE_OFFS + 0x0000d000 + 0x400 * (n) + 0x4 * (k))
#define HWIO_GSI_MAP_EE_n_CH_k_VP_TABLE_RMSK                                                            0x1ff
#define HWIO_GSI_MAP_EE_n_CH_k_VP_TABLE_MAXn                                                                4
#define HWIO_GSI_MAP_EE_n_CH_k_VP_TABLE_MAXk                                                               40
...
#define HWIO_GSI_TEST_BUS_SEL_ADDR                                                                 (GSI_REG_BASE      + 0x00005000)
#define HWIO_GSI_TEST_BUS_SEL_PHYS                                                                 (GSI_REG_BASE_PHYS + 0x00005000)
#define HWIO_GSI_TEST_BUS_SEL_OFFS                                                                 (GSI_REG_BASE_OFFS + 0x00005000)
...
#define HWIO_GSI_TEST_BUS_REG_ADDR                                                                 (GSI_REG_BASE      + 0x00005008)
#define HWIO_GSI_TEST_BUS_REG_PHYS                                                                 (GSI_REG_BASE_PHYS + 0x00005008)
#define HWIO_GSI_TEST_BUS_REG_OFFS                                                                 (GSI_REG_BASE_OFFS + 0x00005008)
...
#define HWIO_GSI_DEBUG_BUSY_REG_ADDR                                                               (GSI_REG_BASE      + 0x00005010)
#define HWIO_GSI_DEBUG_BUSY_REG_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00005010)
#define HWIO_GSI_DEBUG_BUSY_REG_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00005010)
...
#define HWIO_GSI_DEBUG_EVENT_PENDING_n_ADDR(n)                                                     (GSI_REG_BASE      + 0x00005d80 + 0x4 * (n))
#define HWIO_GSI_DEBUG_EVENT_PENDING_n_PHYS(n)                                                     (GSI_REG_BASE_PHYS + 0x00005d80 + 0x4 * (n))
#define HWIO_GSI_DEBUG_EVENT_PENDING_n_OFFS(n)                                                     (GSI_REG_BASE_OFFS + 0x00005d80 + 0x4 * (n))
#define HWIO_GSI_DEBUG_EVENT_PENDING_n_RMSK                                                        0xffffffff
#define HWIO_GSI_DEBUG_EVENT_PENDING_n_MAXn                                                                 1
...
#define HWIO_GSI_DEBUG_TIMER_PENDING_n_ADDR(n)                                                     (GSI_REG_BASE      + 0x00005da0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_TIMER_PENDING_n_PHYS(n)                                                     (GSI_REG_BASE_PHYS + 0x00005da0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_TIMER_PENDING_n_OFFS(n)                                                     (GSI_REG_BASE_OFFS + 0x00005da0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_TIMER_PENDING_n_RMSK                                                        0xffffffff
#define HWIO_GSI_DEBUG_TIMER_PENDING_n_MAXn                                                                 1
...
#define HWIO_GSI_DEBUG_RD_WR_PENDING_n_ADDR(n)                                                     (GSI_REG_BASE      + 0x00005dc0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_RD_WR_PENDING_n_PHYS(n)                                                     (GSI_REG_BASE_PHYS + 0x00005dc0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_RD_WR_PENDING_n_OFFS(n)                                                     (GSI_REG_BASE_OFFS + 0x00005dc0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_RD_WR_PENDING_n_RMSK                                                        0xffffffff
#define HWIO_GSI_DEBUG_RD_WR_PENDING_n_MAXn                                                                 1
...
#define HWIO_GSI_SPARE_REG_1_ADDR                                                                  (GSI_REG_BASE      + 0x00005030)
#define HWIO_GSI_SPARE_REG_1_PHYS                                                                  (GSI_REG_BASE_PHYS + 0x00005030)
#define HWIO_GSI_SPARE_REG_1_OFFS                                                                  (GSI_REG_BASE_OFFS + 0x00005030)
...
#define HWIO_GSI_DEBUG_PC_FROM_SW_ADDR                                                             (GSI_REG_BASE      + 0x00005040)
#define HWIO_GSI_DEBUG_PC_FROM_SW_PHYS                                                             (GSI_REG_BASE_PHYS + 0x00005040)
#define HWIO_GSI_DEBUG_PC_FROM_SW_OFFS                                                             (GSI_REG_BASE_OFFS + 0x00005040)
...
#define HWIO_GSI_DEBUG_SW_STALL_ADDR                                                               (GSI_REG_BASE      + 0x00005044)
#define HWIO_GSI_DEBUG_SW_STALL_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00005044)
#define HWIO_GSI_DEBUG_SW_STALL_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00005044)
...
#define HWIO_GSI_DEBUG_PC_FOR_DEBUG_ADDR                                                           (GSI_REG_BASE      + 0x00005048)
#define HWIO_GSI_DEBUG_PC_FOR_DEBUG_PHYS                                                           (GSI_REG_BASE_PHYS + 0x00005048)
#define HWIO_GSI_DEBUG_PC_FOR_DEBUG_OFFS                                                           (GSI_REG_BASE_OFFS + 0x00005048)
...
#define HWIO_GSI_DEBUG_QSB_LOG_SEL_ADDR                                                            (GSI_REG_BASE      + 0x00005050)
#define HWIO_GSI_DEBUG_QSB_LOG_SEL_PHYS                                                            (GSI_REG_BASE_PHYS + 0x00005050)
#define HWIO_GSI_DEBUG_QSB_LOG_SEL_OFFS                                                            (GSI_REG_BASE_OFFS + 0x00005050)
...
#define HWIO_GSI_DEBUG_QSB_LOG_CLR_ADDR                                                            (GSI_REG_BASE      + 0x00005058)
#define HWIO_GSI_DEBUG_QSB_LOG_CLR_PHYS                                                            (GSI_REG_BASE_PHYS + 0x00005058)
#define HWIO_GSI_DEBUG_QSB_LOG_CLR_OFFS                                                            (GSI_REG_BASE_OFFS + 0x00005058)
...
#define HWIO_GSI_DEBUG_QSB_LOG_ERR_TRNS_ID_ADDR                                                    (GSI_REG_BASE      + 0x00005060)
#define HWIO_GSI_DEBUG_QSB_LOG_ERR_TRNS_ID_PHYS                                                    (GSI_REG_BASE_PHYS + 0x00005060)
#define HWIO_GSI_DEBUG_QSB_LOG_ERR_TRNS_ID_OFFS                                                    (GSI_REG_BASE_OFFS + 0x00005060)
...
#define HWIO_GSI_DEBUG_QSB_LOG_0_ADDR                                                              (GSI_REG_BASE      + 0x00005064)
#define HWIO_GSI_DEBUG_QSB_LOG_0_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00005064)
#define HWIO_GSI_DEBUG_QSB_LOG_0_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00005064)
...
#define HWIO_GSI_DEBUG_QSB_LOG_1_ADDR                                                              (GSI_REG_BASE      + 0x00005068)
#define HWIO_GSI_DEBUG_QSB_LOG_1_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00005068)
#define HWIO_GSI_DEBUG_QSB_LOG_1_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00005068)
...
#define HWIO_GSI_DEBUG_QSB_LOG_2_ADDR                                                              (GSI_REG_BASE      + 0x0000506c)
#define HWIO_GSI_DEBUG_QSB_LOG_2_PHYS                                                              (GSI_REG_BASE_PHYS + 0x0000506c)
#define HWIO_GSI_DEBUG_QSB_LOG_2_OFFS                                                              (GSI_REG_BASE_OFFS + 0x0000506c)
...
#define HWIO_GSI_DEBUG_QSB_LOG_LAST_MISC_IDn_ADDR(n)                                               (GSI_REG_BASE      + 0x00005070 + 0x4 * (n))
#define HWIO_GSI_DEBUG_QSB_LOG_LAST_MISC_IDn_PHYS(n)                                               (GSI_REG_BASE_PHYS + 0x00005070 + 0x4 * (n))
#define HWIO_GSI_DEBUG_QSB_LOG_LAST_MISC_IDn_OFFS(n)                                               (GSI_REG_BASE_OFFS + 0x00005070 + 0x4 * (n))
...
#define HWIO_GSI_DEBUG_SW_RF_n_WRITE_ADDR(n)                                                       (GSI_REG_BASE      + 0x00005080 + 0x4 * (n))
#define HWIO_GSI_DEBUG_SW_RF_n_WRITE_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00005080 + 0x4 * (n))
#define HWIO_GSI_DEBUG_SW_RF_n_WRITE_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00005080 + 0x4 * (n))
...
#define HWIO_GSI_DEBUG_SW_RF_n_READ_ADDR(n)                                                        (GSI_REG_BASE      + 0x00005100 + 0x4 * (n))
#define HWIO_GSI_DEBUG_SW_RF_n_READ_PHYS(n)                                                        (GSI_REG_BASE_PHYS + 0x00005100 + 0x4 * (n))
#define HWIO_GSI_DEBUG_SW_RF_n_READ_OFFS(n)                                                        (GSI_REG_BASE_OFFS + 0x00005100 + 0x4 * (n))
...
#define HWIO_GSI_DEBUG_COUNTER_CFGn_ADDR(n)                                                        (GSI_REG_BASE      + 0x00005180 + 0x4 * (n))
#define HWIO_GSI_DEBUG_COUNTER_CFGn_PHYS(n)                                                        (GSI_REG_BASE_PHYS + 0x00005180 + 0x4 * (n))
#define HWIO_GSI_DEBUG_COUNTER_CFGn_OFFS(n)                                                        (GSI_REG_BASE_OFFS + 0x00005180 + 0x4 * (n))
#define HWIO_GSI_DEBUG_COUNTER_CFGn_RMSK                                                           0x801fffff
...
#define HWIO_GSI_DEBUG_COUNTERn_ADDR(n)                                                            (GSI_REG_BASE      + 0x000051a0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_COUNTERn_PHYS(n)                                                            (GSI_REG_BASE_PHYS + 0x000051a0 + 0x4 * (n))
#define HWIO_GSI_DEBUG_COUNTERn_OFFS(n)                                                            (GSI_REG_BASE_OFFS + 0x000051a0 + 0x4 * (n))
...
#define HWIO_GSI_DEBUG_SW_MSK_REG_n_SEC_k_WR_ADDR(n,k)                                             (GSI_REG_BASE      + 0x000051c0 + 0x4 * (n) + 0x24 * (k))
#define HWIO_GSI_DEBUG_SW_MSK_REG_n_SEC_k_WR_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x000051c0 + 0x4 * (n) + 0x24 * (k))
#define HWIO_GSI_DEBUG_SW_MSK_REG_n_SEC_k_WR_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x000051c0 + 0x4 * (n) + 0x24 * (k))
...
#define HWIO_GSI_DEBUG_SW_MSK_REG_n_SEC_k_RD_ADDR(n,k)                                             (GSI_REG_BASE      + 0x000052e0 + 0x4 * (n) + 0x24 * (k))
#define HWIO_GSI_DEBUG_SW_MSK_REG_n_SEC_k_RD_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x000052e0 + 0x4 * (n) + 0x24 * (k))
#define HWIO_GSI_DEBUG_SW_MSK_REG_n_SEC_k_RD_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x000052e0 + 0x4 * (n) + 0x24 * (k))
...
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_ADDR(n,k)                                                (GSI_REG_BASE      + 0x00005400 + 0xA8 * (n) + 0x4 * (k))
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_PHYS(n,k)                                                (GSI_REG_BASE_PHYS + 0x00005400 + 0xA8 * (n) + 0x4 * (k))
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_OFFS(n,k)                                                (GSI_REG_BASE_OFFS + 0x00005400 + 0xA8 * (n) + 0x4 * (k))
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_RMSK                                                          0x1ff
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_MAXn                                                              4
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_MAXk                                                             40
...
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_ADDR(n,k)                                                (GSI_REG_BASE      + 0x00005800 + 0x100 * (n) + 0x4 * (k))
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_PHYS(n,k)                                                (GSI_REG_BASE_PHYS + 0x00005800 + 0x100 * (n) + 0x4 * (k))
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_OFFS(n,k)                                                (GSI_REG_BASE_OFFS + 0x00005800 + 0x100 * (n) + 0x4 * (k))
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_RMSK                                                          0x1ff
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_MAXn                                                              4
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_MAXk                                                             40
...
#define HWIO_GSI_DEBUG_SDMA_TRANS_DB_n_ADDR(n)                                                     (GSI_REG_BASE      + 0x00005d00 + 0x4 * (n))
#define HWIO_GSI_DEBUG_SDMA_TRANS_DB_n_PHYS(n)                                                     (GSI_REG_BASE_PHYS + 0x00005d00 + 0x4 * (n))
#define HWIO_GSI_DEBUG_SDMA_TRANS_DB_n_OFFS(n)                                                     (GSI_REG_BASE_OFFS + 0x00005d00 + 0x4 * (n))
...
#define HWIO_GSI_DEBUG_REE_PREFETCH_BUF_CH_ID_ADDR                                                 (GSI_REG_BASE      + 0x00005d54)
#define HWIO_GSI_DEBUG_REE_PREFETCH_BUF_CH_ID_PHYS                                                 (GSI_REG_BASE_PHYS + 0x00005d54)
#define HWIO_GSI_DEBUG_REE_PREFETCH_BUF_CH_ID_OFFS                                                 (GSI_REG_BASE_OFFS + 0x00005d54)
...
#define HWIO_GSI_DEBUG_REE_PREFETCH_BUF_STATUS_ADDR                                                (GSI_REG_BASE      + 0x00005d58)
#define HWIO_GSI_DEBUG_REE_PREFETCH_BUF_STATUS_PHYS                                                (GSI_REG_BASE_PHYS + 0x00005d58)
#define HWIO_GSI_DEBUG_REE_PREFETCH_BUF_STATUS_OFFS                                                (GSI_REG_BASE_OFFS + 0x00005d58)
...
#define HWIO_GSI_MCS_PROFILING_BP_CNT_LSB_ADDR                                                     (GSI_REG_BASE      + 0x00005d5c)
#define HWIO_GSI_MCS_PROFILING_BP_CNT_LSB_PHYS                                                     (GSI_REG_BASE_PHYS + 0x00005d5c)
#define HWIO_GSI_MCS_PROFILING_BP_CNT_LSB_OFFS                                                     (GSI_REG_BASE_OFFS + 0x00005d5c)
...
#define HWIO_GSI_MCS_PROFILING_BP_CNT_MSB_ADDR                                                     (GSI_REG_BASE      + 0x00005d60)
#define HWIO_GSI_MCS_PROFILING_BP_CNT_MSB_PHYS                                                     (GSI_REG_BASE_PHYS + 0x00005d60)
#define HWIO_GSI_MCS_PROFILING_BP_CNT_MSB_OFFS                                                     (GSI_REG_BASE_OFFS + 0x00005d60)
...
#define HWIO_GSI_MCS_PROFILING_BP_AND_PENDING_CNT_LSB_ADDR                                         (GSI_REG_BASE      + 0x00005d64)
#define HWIO_GSI_MCS_PROFILING_BP_AND_PENDING_CNT_LSB_PHYS                                         (GSI_REG_BASE_PHYS + 0x00005d64)
#define HWIO_GSI_MCS_PROFILING_BP_AND_PENDING_CNT_LSB_OFFS                                         (GSI_REG_BASE_OFFS + 0x00005d64)
...
#define HWIO_GSI_MCS_PROFILING_BP_AND_PENDING_CNT_MSB_ADDR                                         (GSI_REG_BASE      + 0x00005d68)
#define HWIO_GSI_MCS_PROFILING_BP_AND_PENDING_CNT_MSB_PHYS                                         (GSI_REG_BASE_PHYS + 0x00005d68)
#define HWIO_GSI_MCS_PROFILING_BP_AND_PENDING_CNT_MSB_OFFS                                         (GSI_REG_BASE_OFFS + 0x00005d68)
...
#define HWIO_GSI_MCS_PROFILING_MCS_BUSY_CNT_LSB_ADDR                                               (GSI_REG_BASE      + 0x00005d6c)
#define HWIO_GSI_MCS_PROFILING_MCS_BUSY_CNT_LSB_PHYS                                               (GSI_REG_BASE_PHYS + 0x00005d6c)
#define HWIO_GSI_MCS_PROFILING_MCS_BUSY_CNT_LSB_OFFS                                               (GSI_REG_BASE_OFFS + 0x00005d6c)
...
#define HWIO_GSI_MCS_PROFILING_MCS_BUSY_CNT_MSB_ADDR                                               (GSI_REG_BASE      + 0x00005d70)
#define HWIO_GSI_MCS_PROFILING_MCS_BUSY_CNT_MSB_PHYS                                               (GSI_REG_BASE_PHYS + 0x00005d70)
#define HWIO_GSI_MCS_PROFILING_MCS_BUSY_CNT_MSB_OFFS                                               (GSI_REG_BASE_OFFS + 0x00005d70)
...
#define HWIO_GSI_MCS_PROFILING_MCS_IDLE_CNT_LSB_ADDR                                               (GSI_REG_BASE      + 0x00005d74)
#define HWIO_GSI_MCS_PROFILING_MCS_IDLE_CNT_LSB_PHYS                                               (GSI_REG_BASE_PHYS + 0x00005d74)
#define HWIO_GSI_MCS_PROFILING_MCS_IDLE_CNT_LSB_OFFS                                               (GSI_REG_BASE_OFFS + 0x00005d74)
...
#define HWIO_GSI_MCS_PROFILING_MCS_IDLE_CNT_MSB_ADDR                                               (GSI_REG_BASE      + 0x00005d78)
#define HWIO_GSI_MCS_PROFILING_MCS_IDLE_CNT_MSB_PHYS                                               (GSI_REG_BASE_PHYS + 0x00005d78)
#define HWIO_GSI_MCS_PROFILING_MCS_IDLE_CNT_MSB_OFFS                                               (GSI_REG_BASE_OFFS + 0x00005d78)
...
#define HWIO_GSI_UC_SRC_IRQ_ADDR                                                                   (GSI_REG_BASE      + 0x00004500)
#define HWIO_GSI_UC_SRC_IRQ_PHYS                                                                   (GSI_REG_BASE_PHYS + 0x00004500)
#define HWIO_GSI_UC_SRC_IRQ_OFFS                                                                   (GSI_REG_BASE_OFFS + 0x00004500)
...
#define HWIO_GSI_UC_SRC_IRQ_MSK_ADDR                                                               (GSI_REG_BASE      + 0x00004504)
#define HWIO_GSI_UC_SRC_IRQ_MSK_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00004504)
#define HWIO_GSI_UC_SRC_IRQ_MSK_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00004504)
#define HWIO_GSI_UC_SRC_IRQ_MSK_RMSK                                                                      0xf
#define HWIO_GSI_UC_SRC_IRQ_MSK_ATTR                                                                      0x1
...
#define HWIO_GSI_UC_SRC_IRQ_CLR_ADDR                                                               (GSI_REG_BASE      + 0x00004508)
#define HWIO_GSI_UC_SRC_IRQ_CLR_PHYS                                                               (GSI_REG_BASE_PHYS + 0x00004508)
#define HWIO_GSI_UC_SRC_IRQ_CLR_OFFS                                                               (GSI_REG_BASE_OFFS + 0x00004508)
#define HWIO_GSI_UC_SRC_IRQ_CLR_RMSK                                                                      0xf
#define HWIO_GSI_UC_SRC_IRQ_CLR_ATTR                                                                      0x1
#define HWIO_GSI_UC_SRC_IRQ_CLR_IN          \
        in_dword_masked(HWIO_GSI_UC_SRC_IRQ_CLR_ADDR, HWIO_GSI_UC_SRC_IRQ_CLR_RMSK)
#define HWIO_GSI_UC_SRC_IRQ_CLR_INM(m)      \
        in_dword_masked(HWIO_GSI_UC_SRC_IRQ_CLR_ADDR, m)
...
#define HWIO_GSI_ACC_ARGS_n_ADDR(n)                                                                (GSI_REG_BASE      + 0x0000450c + 0x4 * (n))
#define HWIO_GSI_ACC_ARGS_n_PHYS(n)                                                                (GSI_REG_BASE_PHYS + 0x0000450c + 0x4 * (n))
#define HWIO_GSI_ACC_ARGS_n_OFFS(n)                                                                (GSI_REG_BASE_OFFS + 0x0000450c + 0x4 * (n))
#define HWIO_GSI_ACC_ARGS_n_RMSK                                                                   0xffffffff
#define HWIO_GSI_ACC_ARGS_n_MAXn                                                                            5
#define HWIO_GSI_ACC_ARGS_n_ATTR                                                                          0x1
...
#define HWIO_GSI_ACC_ROUTINE_ADDR                                                                  (GSI_REG_BASE      + 0x00004524)
#define HWIO_GSI_ACC_ROUTINE_PHYS                                                                  (GSI_REG_BASE_PHYS + 0x00004524)
#define HWIO_GSI_ACC_ROUTINE_OFFS                                                                  (GSI_REG_BASE_OFFS + 0x00004524)
#define HWIO_GSI_ACC_ROUTINE_RMSK                                                                  0xffffffff
#define HWIO_GSI_ACC_ROUTINE_ATTR                                                                         0x1
...
#define HWIO_GSI_ACC_GO_ADDR                                                                       (GSI_REG_BASE      + 0x00004528)
#define HWIO_GSI_ACC_GO_PHYS                                                                       (GSI_REG_BASE_PHYS + 0x00004528)
#define HWIO_GSI_ACC_GO_OFFS                                                                       (GSI_REG_BASE_OFFS + 0x00004528)
#define HWIO_GSI_ACC_GO_RMSK                                                                             0x7f
#define HWIO_GSI_ACC_GO_ATTR                                                                              0x1
#define HWIO_GSI_ACC_GO_IN          \
        in_dword_masked(HWIO_GSI_ACC_GO_ADDR, HWIO_GSI_ACC_GO_RMSK)
#define HWIO_GSI_ACC_GO_INM(m)      \
        in_dword_masked(HWIO_GSI_ACC_GO_ADDR, m)
...
#define HWIO_GSI_ACC_2_UC_MCS_STTS_ADDR                                                            (GSI_REG_BASE      + 0x0000452c)
#define HWIO_GSI_ACC_2_UC_MCS_STTS_PHYS                                                            (GSI_REG_BASE_PHYS + 0x0000452c)
#define HWIO_GSI_ACC_2_UC_MCS_STTS_OFFS                                                            (GSI_REG_BASE_OFFS + 0x0000452c)
...
#define HWIO_GSI_ACC_2_UC_MCS_RET_VAL_LSB_ADDR                                                     (GSI_REG_BASE      + 0x00004530)
#define HWIO_GSI_ACC_2_UC_MCS_RET_VAL_LSB_PHYS                                                     (GSI_REG_BASE_PHYS + 0x00004530)
#define HWIO_GSI_ACC_2_UC_MCS_RET_VAL_LSB_OFFS                                                     (GSI_REG_BASE_OFFS + 0x00004530)
...
#define HWIO_GSI_ACC_2_UC_MCS_RET_VAL_MSB_ADDR                                                     (GSI_REG_BASE      + 0x00004534)
#define HWIO_GSI_ACC_2_UC_MCS_RET_VAL_MSB_PHYS                                                     (GSI_REG_BASE_PHYS + 0x00004534)
#define HWIO_GSI_ACC_2_UC_MCS_RET_VAL_MSB_OFFS                                                     (GSI_REG_BASE_OFFS + 0x00004534)
...
#define HWIO_GSI_IC_2_UC_MCS_VLD_ADDR                                                              (GSI_REG_BASE      + 0x00004538)
#define HWIO_GSI_IC_2_UC_MCS_VLD_PHYS                                                              (GSI_REG_BASE_PHYS + 0x00004538)
#define HWIO_GSI_IC_2_UC_MCS_VLD_OFFS                                                              (GSI_REG_BASE_OFFS + 0x00004538)
...
#define HWIO_GSI_IC_2_UC_MCS_PC_ADDR                                                               (GSI_REG_BASE      + 0x0000453c)
#define HWIO_GSI_IC_2_UC_MCS_PC_PHYS                                                               (GSI_REG_BASE_PHYS + 0x0000453c)
#define HWIO_GSI_IC_2_UC_MCS_PC_OFFS                                                               (GSI_REG_BASE_OFFS + 0x0000453c)
...
#define HWIO_GSI_IC_2_UC_MCS_ARGS_n_ADDR(n)                                                        (GSI_REG_BASE      + 0x00004540 + 0x4 * (n))
#define HWIO_GSI_IC_2_UC_MCS_ARGS_n_PHYS(n)                                                        (GSI_REG_BASE_PHYS + 0x00004540 + 0x4 * (n))
#define HWIO_GSI_IC_2_UC_MCS_ARGS_n_OFFS(n)                                                        (GSI_REG_BASE_OFFS + 0x00004540 + 0x4 * (n))
#define HWIO_GSI_IC_2_UC_MCS_ARGS_n_RMSK                                                           0xffffffff
#define HWIO_GSI_IC_2_UC_MCS_ARGS_n_MAXn                                                                    5
#define HWIO_GSI_IC_2_UC_MCS_ARGS_n_ATTR                                                                  0x1
...
#define HWIO_GSI_UC_TLV_IN_VLD_ADDR                                                                (GSI_REG_BASE      + 0x00004558)
#define HWIO_GSI_UC_TLV_IN_VLD_PHYS                                                                (GSI_REG_BASE_PHYS + 0x00004558)
#define HWIO_GSI_UC_TLV_IN_VLD_OFFS                                                                (GSI_REG_BASE_OFFS + 0x00004558)
#define HWIO_GSI_UC_TLV_IN_VLD_RMSK                                                                       0x1
#define HWIO_GSI_UC_TLV_IN_VLD_ATTR                                                                       0x1
...
#define HWIO_GSI_UC_TLV_IN_ROUTINE_ADDR                                                            (GSI_REG_BASE      + 0x0000455c)
#define HWIO_GSI_UC_TLV_IN_ROUTINE_PHYS                                                            (GSI_REG_BASE_PHYS + 0x0000455c)
#define HWIO_GSI_UC_TLV_IN_ROUTINE_OFFS                                                            (GSI_REG_BASE_OFFS + 0x0000455c)
#define HWIO_GSI_UC_TLV_IN_ROUTINE_RMSK                                                            0xffffffff
#define HWIO_GSI_UC_TLV_IN_ROUTINE_ATTR                                                                   0x1
...
#define HWIO_GSI_UC_TLV_IN_ARGS_n_ADDR(n)                                                          (GSI_REG_BASE      + 0x00004560 + 0x4 * (n))
#define HWIO_GSI_UC_TLV_IN_ARGS_n_PHYS(n)                                                          (GSI_REG_BASE_PHYS + 0x00004560 + 0x4 * (n))
#define HWIO_GSI_UC_TLV_IN_ARGS_n_OFFS(n)                                                          (GSI_REG_BASE_OFFS + 0x00004560 + 0x4 * (n))
#define HWIO_GSI_UC_TLV_IN_ARGS_n_RMSK                                                             0xffffffff
#define HWIO_GSI_UC_TLV_IN_ARGS_n_MAXn                                                                      5
#define HWIO_GSI_UC_TLV_IN_ARGS_n_ATTR                                                                    0x1
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_0_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018000 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_0_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018000 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_0_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018000 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_0_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_0_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_0_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_1_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018004 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_1_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018004 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_1_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018004 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_1_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_1_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_1_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_2_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018008 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_2_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018008 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_2_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018008 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_2_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_2_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_2_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_3_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x0001800c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_3_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x0001800c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_3_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x0001800c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_3_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_3_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_3_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_4_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018010 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_4_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018010 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_4_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018010 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_4_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_4_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_4_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_5_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018014 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_5_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018014 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_5_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018014 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_5_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_5_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_5_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_6_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018018 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_6_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018018 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_6_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018018 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_6_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_6_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_6_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_7_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x0001801c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_7_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x0001801c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_7_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x0001801c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_7_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_7_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_7_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_CNTXT_8_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00018020 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_8_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00018020 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_8_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00018020 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CNTXT_8_RMSK                                                            0xffffffff
#define HWIO_EE_n_GSI_CH_k_CNTXT_8_MAXn                                                                     4
#define HWIO_EE_n_GSI_CH_k_CNTXT_8_MAXk                                                                    40
...
#define HWIO_EE_n_GSI_CH_k_ELEM_SIZE_SHIFT_ADDR(n,k)                                               (GSI_REG_BASE      + 0x00018024 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_ELEM_SIZE_SHIFT_PHYS(n,k)                                               (GSI_REG_BASE_PHYS + 0x00018024 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_ELEM_SIZE_SHIFT_OFFS(n,k)                                               (GSI_REG_BASE_OFFS + 0x00018024 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_ELEM_SIZE_SHIFT_RMSK                                                           0xf
#define HWIO_EE_n_GSI_CH_k_ELEM_SIZE_SHIFT_MAXn                                                             4
#define HWIO_EE_n_GSI_CH_k_ELEM_SIZE_SHIFT_MAXk                                                            40
...
#define HWIO_EE_n_GSI_CH_k_CH_ALMST_EMPTY_THRSHOLD_ADDR(n,k)                                       (GSI_REG_BASE      + 0x00018028 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CH_ALMST_EMPTY_THRSHOLD_PHYS(n,k)                                       (GSI_REG_BASE_PHYS + 0x00018028 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CH_ALMST_EMPTY_THRSHOLD_OFFS(n,k)                                       (GSI_REG_BASE_OFFS + 0x00018028 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_CH_ALMST_EMPTY_THRSHOLD_RMSK                                                0xffff
#define HWIO_EE_n_GSI_CH_k_CH_ALMST_EMPTY_THRSHOLD_MAXn                                                     4
#define HWIO_EE_n_GSI_CH_k_CH_ALMST_EMPTY_THRSHOLD_MAXk                                                    40
...
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_READ_PTR_ADDR(n,k)                                             (GSI_REG_BASE      + 0x00018040 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_READ_PTR_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x00018040 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_READ_PTR_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x00018040 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_READ_PTR_RMSK                                                    0xffffff
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_READ_PTR_MAXn                                                           4
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_READ_PTR_MAXk                                                          40
...
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR_ADDR(n,k)                                            (GSI_REG_BASE      + 0x00018044 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR_PHYS(n,k)                                            (GSI_REG_BASE_PHYS + 0x00018044 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR_OFFS(n,k)                                            (GSI_REG_BASE_OFFS + 0x00018044 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR_RMSK                                                   0xffffff
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR_MAXn                                                          4
#define HWIO_EE_n_GSI_CH_k_RE_FETCH_WRITE_PTR_MAXk                                                         40
...
#define HWIO_EE_n_GSI_CH_k_QOS_ADDR(n,k)                                                           (GSI_REG_BASE      + 0x00018048 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_QOS_PHYS(n,k)                                                           (GSI_REG_BASE_PHYS + 0x00018048 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_QOS_OFFS(n,k)                                                           (GSI_REG_BASE_OFFS + 0x00018048 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_QOS_RMSK                                                                 0x3ff3f0f
#define HWIO_EE_n_GSI_CH_k_QOS_MAXn                                                                         4
#define HWIO_EE_n_GSI_CH_k_QOS_MAXk                                                                        40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_0_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x0001804c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_0_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x0001804c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_0_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x0001804c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_0_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_0_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_0_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_1_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018050 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_1_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018050 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_1_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018050 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_1_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_1_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_1_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_2_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018054 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_2_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018054 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_2_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018054 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_2_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_2_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_2_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_3_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018058 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_3_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018058 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_3_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018058 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_3_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_3_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_3_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_4_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x0001805c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_4_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x0001805c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_4_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x0001805c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_4_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_4_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_4_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_5_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018060 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_5_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018060 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_5_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018060 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_5_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_5_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_5_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_6_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018064 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_6_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018064 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_6_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018064 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_6_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_6_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_6_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_7_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018068 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_7_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018068 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_7_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018068 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_7_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_7_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_7_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_8_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x0001806c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_8_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x0001806c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_8_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x0001806c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_8_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_8_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_8_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_SCRATCH_9_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00018070 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_9_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00018070 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_9_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00018070 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_SCRATCH_9_RMSK                                                          0xffffffff
#define HWIO_EE_n_GSI_CH_k_SCRATCH_9_MAXn                                                                   4
#define HWIO_EE_n_GSI_CH_k_SCRATCH_9_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_CH_k_DB_ENG_WRITE_PTR_ADDR(n,k)                                              (GSI_REG_BASE      + 0x00018074 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_DB_ENG_WRITE_PTR_PHYS(n,k)                                              (GSI_REG_BASE_PHYS + 0x00018074 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_DB_ENG_WRITE_PTR_OFFS(n,k)                                              (GSI_REG_BASE_OFFS + 0x00018074 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_GSI_CH_k_DB_ENG_WRITE_PTR_RMSK                                                       0xffff
#define HWIO_EE_n_GSI_CH_k_DB_ENG_WRITE_PTR_MAXn                                                            4
#define HWIO_EE_n_GSI_CH_k_DB_ENG_WRITE_PTR_MAXk                                                           40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_0_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020000 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_0_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020000 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_0_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020000 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_0_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_0_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_0_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_1_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020004 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_1_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020004 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_1_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020004 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_1_RMSK                                                               0xffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_1_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_1_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_2_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020008 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_2_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020008 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_2_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020008 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_2_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_2_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_2_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_3_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x0002000c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_3_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x0002000c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_3_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x0002000c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_3_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_3_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_3_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_4_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020010 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_4_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020010 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_4_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020010 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_4_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_4_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_4_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_5_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020014 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_5_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020014 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_5_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020014 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_5_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_5_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_5_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_6_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020018 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_6_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020018 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_6_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020018 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_6_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_6_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_6_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_7_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x0002001c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_7_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x0002001c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_7_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x0002001c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_7_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_7_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_7_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_8_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020020 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_8_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020020 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_8_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020020 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_8_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_8_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_8_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_9_ADDR(n,k)                                                        (GSI_REG_BASE      + 0x00020024 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_9_PHYS(n,k)                                                        (GSI_REG_BASE_PHYS + 0x00020024 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_9_OFFS(n,k)                                                        (GSI_REG_BASE_OFFS + 0x00020024 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_9_RMSK                                                             0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_9_MAXn                                                                      4
#define HWIO_EE_n_EV_CH_k_CNTXT_9_MAXk                                                                     40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_10_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00020028 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_10_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00020028 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_10_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00020028 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_10_RMSK                                                            0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_10_MAXn                                                                     4
#define HWIO_EE_n_EV_CH_k_CNTXT_10_MAXk                                                                    40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_11_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x0002002c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_11_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x0002002c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_11_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x0002002c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_11_RMSK                                                            0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_11_MAXn                                                                     4
#define HWIO_EE_n_EV_CH_k_CNTXT_11_MAXk                                                                    40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_12_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00020030 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_12_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00020030 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_12_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00020030 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_12_RMSK                                                            0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_12_MAXn                                                                     4
#define HWIO_EE_n_EV_CH_k_CNTXT_12_MAXk                                                                    40
...
#define HWIO_EE_n_EV_CH_k_CNTXT_13_ADDR(n,k)                                                       (GSI_REG_BASE      + 0x00020034 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_13_PHYS(n,k)                                                       (GSI_REG_BASE_PHYS + 0x00020034 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_13_OFFS(n,k)                                                       (GSI_REG_BASE_OFFS + 0x00020034 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_CNTXT_13_RMSK                                                            0xffffffff
#define HWIO_EE_n_EV_CH_k_CNTXT_13_MAXn                                                                     4
#define HWIO_EE_n_EV_CH_k_CNTXT_13_MAXk                                                                    40
...
#define HWIO_EE_n_EV_CH_k_ELEM_SIZE_SHIFT_ADDR(n,k)                                                (GSI_REG_BASE      + 0x00020038 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_ELEM_SIZE_SHIFT_PHYS(n,k)                                                (GSI_REG_BASE_PHYS + 0x00020038 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_ELEM_SIZE_SHIFT_OFFS(n,k)                                                (GSI_REG_BASE_OFFS + 0x00020038 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_ELEM_SIZE_SHIFT_RMSK                                                            0xf
#define HWIO_EE_n_EV_CH_k_ELEM_SIZE_SHIFT_MAXn                                                              4
#define HWIO_EE_n_EV_CH_k_ELEM_SIZE_SHIFT_MAXk                                                             40
...
#define HWIO_EE_n_EV_CH_k_SCRATCH_0_ADDR(n,k)                                                      (GSI_REG_BASE      + 0x00020048 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_0_PHYS(n,k)                                                      (GSI_REG_BASE_PHYS + 0x00020048 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_0_OFFS(n,k)                                                      (GSI_REG_BASE_OFFS + 0x00020048 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_0_RMSK                                                           0xffffffff
#define HWIO_EE_n_EV_CH_k_SCRATCH_0_MAXn                                                                    4
#define HWIO_EE_n_EV_CH_k_SCRATCH_0_MAXk                                                                   40
...
#define HWIO_EE_n_EV_CH_k_SCRATCH_1_ADDR(n,k)                                                      (GSI_REG_BASE      + 0x0002004c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_1_PHYS(n,k)                                                      (GSI_REG_BASE_PHYS + 0x0002004c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_1_OFFS(n,k)                                                      (GSI_REG_BASE_OFFS + 0x0002004c + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_1_RMSK                                                           0xffffffff
#define HWIO_EE_n_EV_CH_k_SCRATCH_1_MAXn                                                                    4
#define HWIO_EE_n_EV_CH_k_SCRATCH_1_MAXk                                                                   40
...
#define HWIO_EE_n_EV_CH_k_SCRATCH_2_ADDR(n,k)                                                      (GSI_REG_BASE      + 0x00020050 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_2_PHYS(n,k)                                                      (GSI_REG_BASE_PHYS + 0x00020050 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_2_OFFS(n,k)                                                      (GSI_REG_BASE_OFFS + 0x00020050 + 0x12000 * (n) + 0x80 * (k))
#define HWIO_EE_n_EV_CH_k_SCRATCH_2_RMSK                                                           0xffffffff
#define HWIO_EE_n_EV_CH_k_SCRATCH_2_MAXn                                                                    4
#define HWIO_EE_n_EV_CH_k_SCRATCH_2_MAXk                                                                   40
...
#define HWIO_EE_n_GSI_CH_k_DOORBELL_0_ADDR(n,k)                                                    (GSI_REG_BASE      + 0x00028000 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_GSI_CH_k_DOORBELL_0_PHYS(n,k)                                                    (GSI_REG_BASE_PHYS + 0x00028000 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_GSI_CH_k_DOORBELL_0_OFFS(n,k)                                                    (GSI_REG_BASE_OFFS + 0x00028000 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_GSI_CH_k_DOORBELL_0_RMSK                                                         0xffffffff
#define HWIO_EE_n_GSI_CH_k_DOORBELL_0_MAXn                                                                  4
#define HWIO_EE_n_GSI_CH_k_DOORBELL_0_MAXk                                                                 40
...
#define HWIO_EE_n_GSI_CH_k_DOORBELL_1_ADDR(n,k)                                                    (GSI_REG_BASE      + 0x00028004 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_GSI_CH_k_DOORBELL_1_PHYS(n,k)                                                    (GSI_REG_BASE_PHYS + 0x00028004 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_GSI_CH_k_DOORBELL_1_OFFS(n,k)                                                    (GSI_REG_BASE_OFFS + 0x00028004 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_GSI_CH_k_DOORBELL_1_RMSK                                                         0xffffffff
#define HWIO_EE_n_GSI_CH_k_DOORBELL_1_MAXn                                                                  4
#define HWIO_EE_n_GSI_CH_k_DOORBELL_1_MAXk                                                                 40
...
#define HWIO_EE_n_EV_CH_k_DOORBELL_0_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00028800 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_EV_CH_k_DOORBELL_0_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00028800 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_EV_CH_k_DOORBELL_0_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00028800 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_EV_CH_k_DOORBELL_0_RMSK                                                          0xffffffff
#define HWIO_EE_n_EV_CH_k_DOORBELL_0_MAXn                                                                   4
#define HWIO_EE_n_EV_CH_k_DOORBELL_0_MAXk                                                                  40
...
#define HWIO_EE_n_EV_CH_k_DOORBELL_1_ADDR(n,k)                                                     (GSI_REG_BASE      + 0x00028804 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_EV_CH_k_DOORBELL_1_PHYS(n,k)                                                     (GSI_REG_BASE_PHYS + 0x00028804 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_EV_CH_k_DOORBELL_1_OFFS(n,k)                                                     (GSI_REG_BASE_OFFS + 0x00028804 + 0x12000 * (n) + 0x8 * (k))
#define HWIO_EE_n_EV_CH_k_DOORBELL_1_RMSK                                                          0xffffffff
#define HWIO_EE_n_EV_CH_k_DOORBELL_1_MAXn                                                                   4
#define HWIO_EE_n_EV_CH_k_DOORBELL_1_MAXk                                                                  40
...
#define HWIO_EE_n_GSI_STATUS_ADDR(n)                                                               (GSI_REG_BASE      + 0x00029000 + 0x12000 * (n))
#define HWIO_EE_n_GSI_STATUS_PHYS(n)                                                               (GSI_REG_BASE_PHYS + 0x00029000 + 0x12000 * (n))
#define HWIO_EE_n_GSI_STATUS_OFFS(n)                                                               (GSI_REG_BASE_OFFS + 0x00029000 + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_CH_CMD_ADDR(n)                                                               (GSI_REG_BASE      + 0x00029008 + 0x12000 * (n))
#define HWIO_EE_n_GSI_CH_CMD_PHYS(n)                                                               (GSI_REG_BASE_PHYS + 0x00029008 + 0x12000 * (n))
#define HWIO_EE_n_GSI_CH_CMD_OFFS(n)                                                               (GSI_REG_BASE_OFFS + 0x00029008 + 0x12000 * (n))
...
#define HWIO_EE_n_EV_CH_CMD_ADDR(n)                                                                (GSI_REG_BASE      + 0x00029010 + 0x12000 * (n))
#define HWIO_EE_n_EV_CH_CMD_PHYS(n)                                                                (GSI_REG_BASE_PHYS + 0x00029010 + 0x12000 * (n))
#define HWIO_EE_n_EV_CH_CMD_OFFS(n)                                                                (GSI_REG_BASE_OFFS + 0x00029010 + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_EE_GENERIC_CMD_ADDR(n)                                                       (GSI_REG_BASE      + 0x00029018 + 0x12000 * (n))
#define HWIO_EE_n_GSI_EE_GENERIC_CMD_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00029018 + 0x12000 * (n))
#define HWIO_EE_n_GSI_EE_GENERIC_CMD_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00029018 + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_HW_PARAM_0_ADDR(n)                                                           (GSI_REG_BASE      + 0x00029038 + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_0_PHYS(n)                                                           (GSI_REG_BASE_PHYS + 0x00029038 + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_0_OFFS(n)                                                           (GSI_REG_BASE_OFFS + 0x00029038 + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_HW_PARAM_1_ADDR(n)                                                           (GSI_REG_BASE      + 0x0002903c + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_1_PHYS(n)                                                           (GSI_REG_BASE_PHYS + 0x0002903c + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_1_OFFS(n)                                                           (GSI_REG_BASE_OFFS + 0x0002903c + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_HW_PARAM_2_ADDR(n)                                                           (GSI_REG_BASE      + 0x00029040 + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_2_PHYS(n)                                                           (GSI_REG_BASE_PHYS + 0x00029040 + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_2_OFFS(n)                                                           (GSI_REG_BASE_OFFS + 0x00029040 + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_MCS_CODE_VER_ADDR(n)                                                         (GSI_REG_BASE      + 0x00029048 + 0x12000 * (n))
#define HWIO_EE_n_GSI_MCS_CODE_VER_PHYS(n)                                                         (GSI_REG_BASE_PHYS + 0x00029048 + 0x12000 * (n))
#define HWIO_EE_n_GSI_MCS_CODE_VER_OFFS(n)                                                         (GSI_REG_BASE_OFFS + 0x00029048 + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_HW_PARAM_3_ADDR(n)                                                           (GSI_REG_BASE      + 0x0002904c + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_3_PHYS(n)                                                           (GSI_REG_BASE_PHYS + 0x0002904c + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_3_OFFS(n)                                                           (GSI_REG_BASE_OFFS + 0x0002904c + 0x12000 * (n))
...
#define HWIO_EE_n_GSI_HW_PARAM_4_ADDR(n)                                                           (GSI_REG_BASE      + 0x00029050 + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_4_PHYS(n)                                                           (GSI_REG_BASE_PHYS + 0x00029050 + 0x12000 * (n))
#define HWIO_EE_n_GSI_HW_PARAM_4_OFFS(n)                                                           (GSI_REG_BASE_OFFS + 0x00029050 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_TYPE_IRQ_ADDR(n)                                                           (GSI_REG_BASE      + 0x00029080 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_TYPE_IRQ_PHYS(n)                                                           (GSI_REG_BASE_PHYS + 0x00029080 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_TYPE_IRQ_OFFS(n)                                                           (GSI_REG_BASE_OFFS + 0x00029080 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_TYPE_IRQ_MSK_ADDR(n)                                                       (GSI_REG_BASE      + 0x00029088 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_TYPE_IRQ_MSK_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00029088 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_TYPE_IRQ_MSK_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00029088 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_k_ADDR(n,k)                                                 (GSI_REG_BASE      + 0x00029090 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_k_PHYS(n,k)                                                 (GSI_REG_BASE_PHYS + 0x00029090 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_k_OFFS(n,k)                                                 (GSI_REG_BASE_OFFS + 0x00029090 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_k_RMSK                                                      0xffffffff
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_k_MAXn                                                               4
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_k_MAXk                                                               1
...
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k_ADDR(n,k)                                             (GSI_REG_BASE      + 0x00029094 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x00029094 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x00029094 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k_RMSK                                                  0xffffffff
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k_MAXn                                                           4
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_MSK_k_MAXk                                                           1
...
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k_ADDR(n,k)                                             (GSI_REG_BASE      + 0x00029098 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x00029098 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x00029098 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k_RMSK                                                  0xffffffff
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k_MAXn                                                           4
#define HWIO_EE_n_CNTXT_SRC_GSI_CH_IRQ_CLR_k_MAXk                                                           1
...
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_k_ADDR(n,k)                                                  (GSI_REG_BASE      + 0x0002909c + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_k_PHYS(n,k)                                                  (GSI_REG_BASE_PHYS + 0x0002909c + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_k_OFFS(n,k)                                                  (GSI_REG_BASE_OFFS + 0x0002909c + 0x24 * (k) + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_MSK_k_ADDR(n,k)                                              (GSI_REG_BASE      + 0x000290a0 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_MSK_k_PHYS(n,k)                                              (GSI_REG_BASE_PHYS + 0x000290a0 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_MSK_k_OFFS(n,k)                                              (GSI_REG_BASE_OFFS + 0x000290a0 + 0x24 * (k) + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_CLR_k_ADDR(n,k)                                              (GSI_REG_BASE      + 0x000290a4 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_CLR_k_PHYS(n,k)                                              (GSI_REG_BASE_PHYS + 0x000290a4 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_EV_CH_IRQ_CLR_k_OFFS(n,k)                                              (GSI_REG_BASE_OFFS + 0x000290a4 + 0x24 * (k) + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_k_ADDR(n,k)                                                   (GSI_REG_BASE      + 0x000290a8 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_k_PHYS(n,k)                                                   (GSI_REG_BASE_PHYS + 0x000290a8 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_k_OFFS(n,k)                                                   (GSI_REG_BASE_OFFS + 0x000290a8 + 0x24 * (k) + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_MSK_k_ADDR(n,k)                                               (GSI_REG_BASE      + 0x000290ac + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_MSK_k_PHYS(n,k)                                               (GSI_REG_BASE_PHYS + 0x000290ac + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_MSK_k_OFFS(n,k)                                               (GSI_REG_BASE_OFFS + 0x000290ac + 0x24 * (k) + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_CLR_k_ADDR(n,k)                                               (GSI_REG_BASE      + 0x000290b0 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_CLR_k_PHYS(n,k)                                               (GSI_REG_BASE_PHYS + 0x000290b0 + 0x24 * (k) + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SRC_IEOB_IRQ_CLR_k_OFFS(n,k)                                               (GSI_REG_BASE_OFFS + 0x000290b0 + 0x24 * (k) + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_GLOB_IRQ_STTS_ADDR(n)                                                      (GSI_REG_BASE      + 0x00029200 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GLOB_IRQ_STTS_PHYS(n)                                                      (GSI_REG_BASE_PHYS + 0x00029200 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GLOB_IRQ_STTS_OFFS(n)                                                      (GSI_REG_BASE_OFFS + 0x00029200 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_GLOB_IRQ_EN_ADDR(n)                                                        (GSI_REG_BASE      + 0x00029204 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GLOB_IRQ_EN_PHYS(n)                                                        (GSI_REG_BASE_PHYS + 0x00029204 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GLOB_IRQ_EN_OFFS(n)                                                        (GSI_REG_BASE_OFFS + 0x00029204 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_GLOB_IRQ_CLR_ADDR(n)                                                       (GSI_REG_BASE      + 0x00029208 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GLOB_IRQ_CLR_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00029208 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GLOB_IRQ_CLR_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00029208 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_STTS_ADDR(n)                                                       (GSI_REG_BASE      + 0x0002920c + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GSI_IRQ_STTS_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x0002920c + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GSI_IRQ_STTS_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x0002920c + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_EN_ADDR(n)                                                         (GSI_REG_BASE      + 0x00029210 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GSI_IRQ_EN_PHYS(n)                                                         (GSI_REG_BASE_PHYS + 0x00029210 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GSI_IRQ_EN_OFFS(n)                                                         (GSI_REG_BASE_OFFS + 0x00029210 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_CLR_ADDR(n)                                                        (GSI_REG_BASE      + 0x00029214 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GSI_IRQ_CLR_PHYS(n)                                                        (GSI_REG_BASE_PHYS + 0x00029214 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_GSI_IRQ_CLR_OFFS(n)                                                        (GSI_REG_BASE_OFFS + 0x00029214 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_INTSET_ADDR(n)                                                             (GSI_REG_BASE      + 0x00029220 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_INTSET_PHYS(n)                                                             (GSI_REG_BASE_PHYS + 0x00029220 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_INTSET_OFFS(n)                                                             (GSI_REG_BASE_OFFS + 0x00029220 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_MSI_BASE_LSB_ADDR(n)                                                       (GSI_REG_BASE      + 0x00029230 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_MSI_BASE_LSB_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00029230 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_MSI_BASE_LSB_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00029230 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_MSI_BASE_MSB_ADDR(n)                                                       (GSI_REG_BASE      + 0x00029234 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_MSI_BASE_MSB_PHYS(n)                                                       (GSI_REG_BASE_PHYS + 0x00029234 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_MSI_BASE_MSB_OFFS(n)                                                       (GSI_REG_BASE_OFFS + 0x00029234 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_INT_VEC_ADDR(n)                                                            (GSI_REG_BASE      + 0x00029238 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_INT_VEC_PHYS(n)                                                            (GSI_REG_BASE_PHYS + 0x00029238 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_INT_VEC_OFFS(n)                                                            (GSI_REG_BASE_OFFS + 0x00029238 + 0x12000 * (n))
...
#define HWIO_EE_n_ERROR_LOG_ADDR(n)                                                                (GSI_REG_BASE      + 0x00029240 + 0x12000 * (n))
#define HWIO_EE_n_ERROR_LOG_PHYS(n)                                                                (GSI_REG_BASE_PHYS + 0x00029240 + 0x12000 * (n))
#define HWIO_EE_n_ERROR_LOG_OFFS(n)                                                                (GSI_REG_BASE_OFFS + 0x00029240 + 0x12000 * (n))
...
#define HWIO_EE_n_ERROR_LOG_CLR_ADDR(n)                                                            (GSI_REG_BASE      + 0x00029244 + 0x12000 * (n))
#define HWIO_EE_n_ERROR_LOG_CLR_PHYS(n)                                                            (GSI_REG_BASE_PHYS + 0x00029244 + 0x12000 * (n))
#define HWIO_EE_n_ERROR_LOG_CLR_OFFS(n)                                                            (GSI_REG_BASE_OFFS + 0x00029244 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SCRATCH_0_ADDR(n)                                                          (GSI_REG_BASE      + 0x00029400 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SCRATCH_0_PHYS(n)                                                          (GSI_REG_BASE_PHYS + 0x00029400 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SCRATCH_0_OFFS(n)                                                          (GSI_REG_BASE_OFFS + 0x00029400 + 0x12000 * (n))
...
#define HWIO_EE_n_CNTXT_SCRATCH_1_ADDR(n)                                                          (GSI_REG_BASE      + 0x00029404 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SCRATCH_1_PHYS(n)                                                          (GSI_REG_BASE_PHYS + 0x00029404 + 0x12000 * (n))
#define HWIO_EE_n_CNTXT_SCRATCH_1_OFFS(n)                                                          (GSI_REG_BASE_OFFS + 0x00029404 + 0x12000 * (n))
...
#define HWIO_GSI_MCS_CFG_ADDR                                                                      (GSI_REG_BASE      + 0x0000f000)
#define HWIO_GSI_MCS_CFG_PHYS                                                                      (GSI_REG_BASE_PHYS + 0x0000f000)
#define HWIO_GSI_MCS_CFG_OFFS                                                                      (GSI_REG_BASE_OFFS + 0x0000f000)
...
#define HWIO_GSI_TZ_FW_AUTH_LOCK_ADDR                                                              (GSI_REG_BASE      + 0x0000f008)
#define HWIO_GSI_TZ_FW_AUTH_LOCK_PHYS                                                              (GSI_REG_BASE_PHYS + 0x0000f008)
#define HWIO_GSI_TZ_FW_AUTH_LOCK_OFFS                                                              (GSI_REG_BASE_OFFS + 0x0000f008)
...
#define HWIO_GSI_MSA_FW_AUTH_LOCK_ADDR                                                             (GSI_REG_BASE      + 0x0000f010)
#define HWIO_GSI_MSA_FW_AUTH_LOCK_PHYS                                                             (GSI_REG_BASE_PHYS + 0x0000f010)
#define HWIO_GSI_MSA_FW_AUTH_LOCK_OFFS                                                             (GSI_REG_BASE_OFFS + 0x0000f010)
...
#define HWIO_GSI_SP_FW_AUTH_LOCK_ADDR                                                              (GSI_REG_BASE      + 0x0000f018)
#define HWIO_GSI_SP_FW_AUTH_LOCK_PHYS                                                              (GSI_REG_BASE_PHYS + 0x0000f018)
#define HWIO_GSI_SP_FW_AUTH_LOCK_OFFS                                                              (GSI_REG_BASE_OFFS + 0x0000f018)
...
#define HWIO_INTER_EE_n_ORIGINATOR_EE_ADDR(n)                                                      (GSI_REG_BASE      + 0x00010000 + 0x1000 * (n))
#define HWIO_INTER_EE_n_ORIGINATOR_EE_PHYS(n)                                                      (GSI_REG_BASE_PHYS + 0x00010000 + 0x1000 * (n))
#define HWIO_INTER_EE_n_ORIGINATOR_EE_OFFS(n)                                                      (GSI_REG_BASE_OFFS + 0x00010000 + 0x1000 * (n))
...
#define HWIO_INTER_EE_n_GSI_CH_CMD_ADDR(n)                                                         (GSI_REG_BASE      + 0x00010008 + 0x1000 * (n))
#define HWIO_INTER_EE_n_GSI_CH_CMD_PHYS(n)                                                         (GSI_REG_BASE_PHYS + 0x00010008 + 0x1000 * (n))
#define HWIO_INTER_EE_n_GSI_CH_CMD_OFFS(n)                                                         (GSI_REG_BASE_OFFS + 0x00010008 + 0x1000 * (n))
...
#define HWIO_INTER_EE_n_EV_CH_CMD_ADDR(n)                                                          (GSI_REG_BASE      + 0x00010010 + 0x1000 * (n))
#define HWIO_INTER_EE_n_EV_CH_CMD_PHYS(n)                                                          (GSI_REG_BASE_PHYS + 0x00010010 + 0x1000 * (n))
#define HWIO_INTER_EE_n_EV_CH_CMD_OFFS(n)                                                          (GSI_REG_BASE_OFFS + 0x00010010 + 0x1000 * (n))
...
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_k_ADDR(n,k)                                                 (GSI_REG_BASE      + 0x00010018 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_k_PHYS(n,k)                                                 (GSI_REG_BASE_PHYS + 0x00010018 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_k_OFFS(n,k)                                                 (GSI_REG_BASE_OFFS + 0x00010018 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_k_RMSK                                                      0xffffffff
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_k_MAXn                                                               4
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_k_MAXk                                                               1
...
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_MSK_k_ADDR(n,k)                                             (GSI_REG_BASE      + 0x0001001c + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_MSK_k_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x0001001c + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_MSK_k_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x0001001c + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_MSK_k_RMSK                                                  0xffffffff
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_MSK_k_MAXn                                                           4
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_MSK_k_MAXk                                                           1
...
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k_ADDR(n,k)                                             (GSI_REG_BASE      + 0x00010020 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k_PHYS(n,k)                                             (GSI_REG_BASE_PHYS + 0x00010020 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k_OFFS(n,k)                                             (GSI_REG_BASE_OFFS + 0x00010020 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k_RMSK                                                  0xffffffff
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k_MAXn                                                           4
#define HWIO_INTER_EE_n_SRC_GSI_CH_IRQ_CLR_k_MAXk                                                           1
...
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_k_ADDR(n,k)                                                  (GSI_REG_BASE      + 0x00010024 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_k_PHYS(n,k)                                                  (GSI_REG_BASE_PHYS + 0x00010024 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_k_OFFS(n,k)                                                  (GSI_REG_BASE_OFFS + 0x00010024 + 0x18 * (k) + 0x1000 * (n))
...
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_MSK_k_ADDR(n,k)                                              (GSI_REG_BASE      + 0x00010028 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_MSK_k_PHYS(n,k)                                              (GSI_REG_BASE_PHYS + 0x00010028 + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_MSK_k_OFFS(n,k)                                              (GSI_REG_BASE_OFFS + 0x00010028 + 0x18 * (k) + 0x1000 * (n))
...
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_CLR_k_ADDR(n,k)                                              (GSI_REG_BASE      + 0x0001002c + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_CLR_k_PHYS(n,k)                                              (GSI_REG_BASE_PHYS + 0x0001002c + 0x18 * (k) + 0x1000 * (n))
#define HWIO_INTER_EE_n_SRC_EV_CH_IRQ_CLR_k_OFFS(n,k)                                              (GSI_REG_BASE_OFFS + 0x0001002c + 0x18 * (k) + 0x1000 * (n))
