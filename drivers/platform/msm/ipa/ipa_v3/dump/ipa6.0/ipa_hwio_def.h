...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_IPSEC_ANTI_REPLAY_INT_STTS 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_stts_s
{
  u32 irq_status : 1;
  u32 reserved0 : 31;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_stts_u
{
  struct ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_stts_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_IPSEC_ANTI_REPLAY_INT_EN 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_en_s
{
  u32 irq_en : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_en_u
{
  struct ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_en_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_IPSEC_ANTI_REPLAY_INT_CLR 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_clr_s
{
  u32 irq_clr : 1;
  u32 reserved0 : 31;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_clr_u
{
  struct ipa_hwio_def_ipa_uc_ipsec_anti_replay_int_clr_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_IPSEC_WORKAROUND_INT_STTS 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_ipsec_workaround_int_stts_s
{
  u32 irq_status : 3;
  u32 reserved0 : 29;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_uc_ipsec_workaround_int_stts_u
{
  struct ipa_hwio_def_ipa_uc_ipsec_workaround_int_stts_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_IPSEC_WORKAROUND_INT_EN 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_ipsec_workaround_int_en_s
{
  u32 irq_en : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_uc_ipsec_workaround_int_en_u
{
  struct ipa_hwio_def_ipa_uc_ipsec_workaround_int_en_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_IPSEC_WORKAROUND_INT_CLR 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_ipsec_workaround_int_clr_s
{
  u32 irq_clr : 3;
  u32 reserved0 : 29;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_uc_ipsec_workaround_int_clr_u
{
  struct ipa_hwio_def_ipa_uc_ipsec_workaround_int_clr_s def;
  u32 value;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_AREA_RAM_DIRECT_ACCESS_n 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_area_ram_direct_access_n_s
{
  u32 data_word : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_area_ram_direct_access_n_u
{
  struct ipa_hwio_def_ipa_ipsec_area_ram_direct_access_n_s def;
  u32 value;
};
...
{
  u32 ipa_uc_pkt_process_context_base : 19;
  u32 reserved0 : 13;
};
...
{
  u32 ipa_uc_pkt_process_pkt_base : 19;
  u32 reserved0 : 13;
};
...
{
  u32 ipa_uc_pkt_process_hdr_base : 19;
  u32 reserved0 : 13;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_UC_PKT_PROCESS_BASE_ADDR_3 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_uc_pkt_process_base_addr_3_s
{
  u32 ipa_uc_pkt_process_sa_base : 19;
  u32 reserved0 : 13;
};

/* Union definition of register */
union ipa_hwio_def_ipa_uc_pkt_process_base_addr_3_u
{
  struct ipa_hwio_def_ipa_uc_pkt_process_base_addr_3_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPS_UC_DRAM_SECTOR_BASE_ADDR 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decaps_uc_dram_sector_base_addr_s
{
  u32 val : 19;
  u32 reserved0 : 13;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decaps_uc_dram_sector_base_addr_u
{
  struct ipa_hwio_def_ipa_ipsec_decaps_uc_dram_sector_base_addr_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_ENCAPSULATION_RESUME 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_encapsulation_resume_s
{
  u32 resume_post_encaps : 1;
  u32 resume_pre_encaps : 1;
  u32 reserved0 : 30;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_encapsulation_resume_u
{
  struct ipa_hwio_def_ipa_ipsec_encapsulation_resume_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_ENCAPSULATION_WA_IRQ_DATA 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_encapsulation_wa_irq_data_s
{
  u32 ctx_id : 8;
  u32 reserved0 : 24;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_encapsulation_wa_irq_data_u
{
  struct ipa_hwio_def_ipa_ipsec_encapsulation_wa_irq_data_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPS_UC_WORKAROUND 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decaps_uc_workaround_s
{
  u32 calc_seq_n_h_en : 1;
  u32 calc_seq_n_h_ready : 1;
  u32 reserved0 : 2;
  u32 auth_error_en : 1;
  u32 auth_error_stt : 1;
  ...
  u32 pad_error_set : 1;
  u32 pad_error_clr : 1;
  u32 anti_replay_error_en : 1;
  u32 anti_replay_error_stt : 1;
  u32 anti_replay_error_set : 1;
  u32 anti_replay_error_clr : 1;
  u32 pkt_out_of_win_error_en : 1;
  u32 pkt_out_of_win_error_stt : 1;
  u32 pkt_out_of_win_error_set : 1;
  u32 pkt_out_of_win_error_clr : 1;
  u32 always_en : 1;
  u32 reserved1 : 10;
  u32 uc_workaround_done : 1;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decaps_uc_workaround_u
{
  struct ipa_hwio_def_ipa_ipsec_decaps_uc_workaround_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPS_ANTI_REPLAY_RESULT 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decaps_anti_replay_result_s
{
  u32 anti_replay_error : 1;
  u32 pkt_out_of_win_error : 1;
  u32 reserved0 : 30;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decaps_anti_replay_result_u
{
  struct ipa_hwio_def_ipa_ipsec_decaps_anti_replay_result_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPS_FORCE_SEQ_N_H 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decaps_force_seq_n_h_s
{
  u32 seq_n_h_val : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decaps_force_seq_n_h_u
{
  struct ipa_hwio_def_ipa_ipsec_decaps_force_seq_n_h_s def;
  u32 value;
};
...
struct ipa_hwio_def_ipa_rsrc_mngr_sw_access_status_s
{
  ...
  u32 rel_ready : 1;
  u32 rsrv_ready : 1;
  u32 alloc_rsrc_id_next : 8;
  u32 srch_rsrc_id_next : 8;
  u32 reserved0 : 12;
};
...
struct ipa_hwio_def_ipa_rsrc_mngr_db_list_read_s
{
  ...
  u32 reserved0 : 2;
  u32 rsrc_list_head_rsrc : 8;
  u32 rsrc_list_head_cnt : 8;
  u32 rsrc_list_entry_cnt : 8;
  u32 reserved1 : 4;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_RAM_IPSEC_ENC_BASE_ADDR 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ram_ipsec_enc_base_addr_s
{
  u32 address : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ram_ipsec_enc_base_addr_u
{
  struct ipa_hwio_def_ipa_ram_ipsec_enc_base_addr_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_RAM_IPSEC_AUTH_BASE_ADDR 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ram_ipsec_auth_base_addr_s
{
  u32 address : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ram_ipsec_auth_base_addr_u
{
  struct ipa_hwio_def_ipa_ram_ipsec_auth_base_addr_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_RAM_FRAG_THIRD_BASE_ADDR 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ram_frag_third_base_addr_s
{
  u32 address : 32;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ram_frag_third_base_addr_u
{
  struct ipa_hwio_def_ipa_ram_frag_third_base_addr_s def;
  u32 value;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_ENCAPSULATION_CFG 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_encapsulation_cfg_s
{
  u32 uc_pre_cyph_en : 1;
  u32 uc_post_cyph_en : 1;
  u32 clib_iv_swap_sel : 6;
  u32 clib_clib_key_swap_sel : 7;
  u32 clib_data_swap_sel : 4;
  u32 clib_auth_sha_iv_swap_sel : 6;
  u32 clib_auth_exp_mac_swap_sel : 6;
  u32 reserved0 : 1;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_encapsulation_cfg_u
{
  struct ipa_hwio_def_ipa_ipsec_encapsulation_cfg_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_ENCAPSULATION_CFG_1 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_encapsulation_cfg_1_s
{
  u32 clib_ccm_init_swap_sel : 4;
  u32 clib_gcm_salt_swap_sel : 2;
  u32 clib_gcm_iv_swap_sel : 3;
  u32 reserved0 : 23;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_encapsulation_cfg_1_u
{
  struct ipa_hwio_def_ipa_ipsec_encapsulation_cfg_1_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_ENCAPSULATION_CLIB_STATUS 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_encapsulation_clib_status_s
{
  ...
  u32 clib_encr_aes_engine_busy : 1;
  u32 reserved0 : 22;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_encapsulation_clib_status_u
{
  struct ipa_hwio_def_ipa_ipsec_encapsulation_clib_status_s def;
  u32 value;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPSULATION_CFG 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decapsulation_cfg_s
{
  u32 clib_gcm_salt_swap_sel : 2;
  u32 clib_iv_swap_sel : 6;
  u32 clib_clib_key_swap_sel : 7;
...
/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decapsulation_cfg_u
{
  struct ipa_hwio_def_ipa_ipsec_decapsulation_cfg_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPSULATION_CFG_1 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decapsulation_cfg_1_s
{
  u32 clib_gcm_iv_swap_sel : 3;
  u32 clib_ccm_init_swap_sel : 4;
  u32 seq_num_l_swap_sel : 2;
  u32 seq_num_h_swap_sel : 2;
  u32 seq_num_h_l_swap_sel : 1;
  u32 reserved0 : 20;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decapsulation_cfg_1_u
{
  struct ipa_hwio_def_ipa_ipsec_decapsulation_cfg_1_s def;
  u32 value;
};

/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_IPSEC_DECAPSULATION_CLIB_STATUS 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ipsec_decapsulation_clib_status_s
{
  u32 clib_encr_din_fifo_empty : 1;
  u32 clib_encr_din_fifo_err : 1;
  u32 clib_encr_dout_fifo_full : 1;
...
/* Union definition of register */
union ipa_hwio_def_ipa_ipsec_decapsulation_clib_status_u
{
  struct ipa_hwio_def_ipa_ipsec_decapsulation_clib_status_s def;
  u32 value;
};
...
struct ipa_hwio_def_ipa_clkon_cfg_1_s
{
  ...
  u32 cgc_open_encaps : 1;
  u32 cgc_open_decaps : 1;
  u32 reserved0 : 26;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_STATE_ENCAPS 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_state_encaps_s
{
  u32 rd_aligner_busy : 1;
  u32 wr_aligner_busy : 1;
  u32 clib_enc_busy : 1;
  u32 clib_auth_busy : 1;
  u32 encaps_write_idle : 1;
  u32 encaps_read_idle : 1;
  u32 encaps_main_idle : 1;
  u32 encaps_idle : 1;
  u32 ctx_id : 8;
  u32 reserved0 : 16;
};
...
/* Union definition of register */
union ipa_hwio_def_ipa_state_encaps_u
{
  struct ipa_hwio_def_ipa_state_encaps_s def;
  u32 value;
};
...
{
  u32 ipa_hps_decaps_empty : 1;
  u32 ipa_hps_decaps_active : 1;
  u32 ipa_hps_encaps_empty : 1;
  u32 ipa_hps_encaps_active : 1;
  u32 reserved0 : 28;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_STATE_DECAPS 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_state_decaps_s
{
  u32 decaps_main_fsm : 4;
  u32 decaps_sa_loader_fsm : 5;
  u32 decaps_pkt_rd_fsm : 4;
  u32 decaps_pkt_rd_field_start : 4;
  u32 esp_padding_error : 1;
  u32 pkt_out_of_win_error : 1;
  u32 anti_replay_error : 1;
  u32 auth_error : 1;
  u32 uc_workaround_done_pulse_sampled : 1;
  u32 crypto_engine_done_sticky : 1;
  u32 sa_loader_done_sticky : 1;
  u32 anti_replay_check_skip : 1;
  u32 anti_replay_check_done : 1;
  u32 pkt_is_non_enc : 1;
  u32 pkt_wr_done_sticky : 1;
  u32 wr_trnseq_aligner_busy : 1;
  u32 wr_accumulator_busy : 1;
  u32 reserved0 : 2;
};

/* Union definition of register */
union ipa_hwio_def_ipa_state_decaps_u
{
  struct ipa_hwio_def_ipa_state_decaps_s def;
  u32 value;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_RAM_INTLV_CFG2 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_ram_intlv_cfg2_s
{
  u32 ipa_ram_intlv_cfg2 : 8;
  u32 reserved0 : 24;
};

/* Union definition of register */
union ipa_hwio_def_ipa_ram_intlv_cfg2_u
{
  struct ipa_hwio_def_ipa_ram_intlv_cfg2_s def;
  u32 value;
};
...
/*===========================================================================*/
/*!
  @brief Bit Field definition of register: IPA_THIRD_FRAG_VALUES 
*/
/*===========================================================================*/
/* Structure definition of register */
struct ipa_hwio_def_ipa_third_frag_values_s
{
  u32 ipa_third_frag_ram_last_addr : 16;
  u32 reserved0 : 8;
  u32 ipa_third_frag_fairness_cnt : 4;
  u32 reserved1 : 4;
};

/* Union definition of register */
union ipa_hwio_def_ipa_third_frag_values_u
{
  struct ipa_hwio_def_ipa_third_frag_values_s def;
  u32 value;
};
...
struct ipa_hwio_def_ipa_src_rsrc_type_01_ctx_n_desc_list_grp_n_s
{
  ...
  u32 rsrc_type_src_desc_list_min_limit : 8;
  u32 rsrc_type_src_desc_list_max_limit : 8;
};
...
{
  u32 rsrc_type_src_ctx_cnt : 8;
  u32 rsrc_type_src_desc_list_cnt : 8;
  u32 rsrc_type_src_desc_buffer_cnt : 8;
  u32 rsrc_type_src_hps_dmar_cnt : 8;
};
...
{
  u32 rsrc_type_src_ack_entry_cnt : 8;
  u32 reserved0 : 24;
};
...
{
  u32 rsrc_type_src_ctx_amount : 8;
  u32 rsrc_type_src_desc_list_amount : 8;
  u32 rsrc_type_src_desc_buffer_amount : 8;
  u32 rsrc_type_src_hps_dmar_amount : 8;
};
...
{
  u32 rsrc_type_src_ack_entry_amount : 8;
  u32 reserved0 : 24;
};
...
{
  u32 rsrc_type_dst_data_sctr_cnt : 8;
  u32 rsrc_type_dst_dps_dmar_cnt : 8;
  u32 rsrc_type_dst_seg_ctx_cnt : 8;
  u32 reserved0 : 8;
};
...
{
  u32 rsrc_type_dst_data_sctr_amount : 8;
  u32 rsrc_type_dst_dps_dmar_amount : 8;
  u32 rsrc_type_dst_seg_ctx_amount : 8;
  u32 reserved0 : 8;
};
...
/*----------------------------------------------------------------------------
 * MODULE: IPA_VMIDMT_SMR_64_SSD8_SID8_MA128_SP1_40
 *--------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
 * MODULE: IPA_RA_XPU_CFG_XPU4_AHB_WRAPPER
 *--------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
 * MODULE: IPA_ER_XPU_CFG_XPU4_AHB_WRAPPER
 *--------------------------------------------------------------------------*/
