...
static struct map_src_dst_addr_s ipa_regs_to_save_array[] = {
	...
	GEN_SRC_DST_ADDR_MAP(IPA_STATE_ACL,
			     ipa.gen,
			     ipa_state_acl),
	GEN_SRC_DST_ADDR_MAP(IPA_STATE_ACL_1,
			     ipa.gen,
			     ipa_state_acl_1),
	...
	GEN_SRC_DST_ADDR_MAP(IPA_NLO_MIN_DSM_CFG,
			     ipa.gen,
			     ipa_nlo_min_dsm_cfg),
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_ULSO_CFG_IP_ID_MIN_VALUE_n,
			     ipa.gen,
			     ipa_ulso_cfg_ip_id_min_value_n),
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_ULSO_CFG_IP_ID_MAX_VALUE_n,
			     ipa.gen,
	...
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_TSP_INGRESS_POLICING_CFG_n,
			     ipa.gen,
			     ipa_tsp_ingress_policing_cfg_n),
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_TSP_INGRESS_POLICING_CFG_ETH_n,
			     ipa.gen,
			     ipa_tsp_ingress_policing_cfg_eth_n),
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_TSP_EGRESS_POLICING_CFG_n,
			     ipa.gen,
			     ipa_tsp_egress_policing_cfg_n),
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_STATE_QMNGR_QUEUE_NONEMPTY_n,
			     ipa.gen,
			     ipa_state_qmngr_queue_nonempty_n),
	...
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP(IPA_ENDP_INIT_CFG_n,
					 ipa_endp_init_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_MODE_EXT_n,
					 ipa_endp_init_mode_ext_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_ETHERNET_CFG_n,
					 ipa_endp_init_ethernet_cfg_n),
	...
	IPA_REG_SAVE_CFG_ENTRY_CONS_PIPE_ENDP(IPA_ENDP_INIT_HDR_METADATA_MASK_n,
					 ipa_endp_init_hdr_metadata_mask_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_HDR_METADATA_n,
					 ipa_endp_init_hdr_metadata_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_MODE_n,
					 ipa_endp_init_mode_n),
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP(IPA_ENDP_INIT_AGGR_n,
					 ipa_endp_init_aggr_n),
	IPA_REG_SAVE_CFG_ENTRY_CONS_PIPE_ENDP(IPA_ENDP_INIT_HOL_BLOCK_EN_n,
					 ipa_endp_init_hol_block_en_n),
	IPA_REG_SAVE_CFG_ENTRY_CONS_PIPE_ENDP(IPA_ENDP_INIT_HOL_BLOCK_TIMER_n,
					 ipa_endp_init_hol_block_timer_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_DEAGGR_n,
	...
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_SEQ_n,
					 ipa_endp_init_seq_n),
	...
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP(IPA_ENDP_GSI_CFG1_n,
					 ipa_endp_gsi_cfg1_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_ULSO_CFG_n,
					ipa_endp_init_ulso_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_NAT_EXC_SUPPRESS_n,
					ipa_endp_init_nat_exc_suppress_n),
	IPA_REG_SAVE_CFG_ENTRY_CONS_PIPE_ENDP(IPA_ENDP_INIT_PROD_CFG_n,
					ipa_endp_init_prod_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_IPSEC_CFG_n,
					ipa_endp_init_ipsec_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PROD_PIPE_ENDP(IPA_ENDP_INIT_DRBIP_CFG_n,
					ipa_endp_init_drbip_cfg_n),
	/* Source Resource Group Config Registers */
	IPA_REG_SAVE_CFG_ENTRY_SRC_RSRC_GRP(IPA_SRC_RSRC_TYPE_01_CTX_N_DESC_LIST_GRP_n,
					    ipa_src_rsrc_type_01_ctx_n_desc_list_grp_n),
	IPA_REG_SAVE_CFG_ENTRY_SRC_RSRC_GRP(IPA_SRC_RSRC_TYPE_23_DESC_BUFFER_N_HPS_DMAR_GRP_n,
					    ipa_src_rsrc_type_23_desc_buffer_n_hps_dmar_grp_n),
	IPA_REG_SAVE_CFG_ENTRY_SRC_RSRC_GRP(IPA_SRC_RSRC_TYPE_4_ACK_ENTRY_GRP_n,
					    ipa_src_rsrc_type_4_ack_entry_grp_n),
	/* Destination Resource Group Config Registers */
	IPA_REG_SAVE_CFG_ENTRY_DST_RSRC_GRP(IPA_DST_RSRC_TYPE_01_DATA_SCTR_N_DPS_DMAR_GRP_n,
					    ipa_dst_rsrc_type_01_data_sctr_n_dps_dmar_grp_n),
	IPA_REG_SAVE_CFG_ENTRY_DST_RSRC_GRP(IPA_DST_RSRC_TYPE_2_SEG_CTX_GRP_n,
					    ipa_dst_rsrc_type_2_seg_ctx_grp_n),
	/* Source Resource Group Count Registers */
	IPA_REG_SAVE_CFG_ENTRY_SRC_RSRC_CNT_GRP(
		IPA_SRC_RSRC_TYPE_CNT_0_WOUT_ACK_ENTRY_GRP_n,
		ipa_src_rsrc_type_cnt_0_wout_ack_entry_grp_n),
	IPA_REG_SAVE_CFG_ENTRY_SRC_RSRC_CNT_GRP(
		IPA_SRC_RSRC_TYPE_CNT_1_ACK_ENTRY_GRP_n,
		ipa_src_rsrc_type_cnt_1_ack_entry_grp_n),
	...
	/* ipa_reg_save_tsp_stop_ch_wa */
	GEN_SRC_DST_ADDR_MAP(IPA_DPS_TX_CMDQ_CFG_RD,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_dps_tx_cmdq_cfg_rd),
	GEN_SRC_DST_ADDR_MAP(IPA_FLAVOR_1,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_flavor_1),
	GEN_SRC_DST_ADDR_MAP_IDX(IPA_PKT_CTX_NUM_m_FIELDS_2,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_pkt_ctx_num_m_fields_2,
			 IPA_HW_PKT_CTNTX_MAX-1),
	GEN_SRC_DST_ADDR_MAP_IDX(IPA_PKT_CTX_NUM_m_FIELDS_14,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_pkt_ctx_num_m_fields_14,
			 IPA_HW_PKT_CTNTX_MAX-1),
	GEN_SRC_DST_ADDR_MAP(IPA_DPS_TX_CMDQ_DATA_WR_0,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_dps_tx_cmdq_data_wr_0),
	GEN_SRC_DST_ADDR_MAP(IPA_DPS_TX_CMDQ_CMD,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_dps_tx_cmdq_cmd),
	GEN_SRC_DST_ADDR_MAP_IDX(IPA_NTF_TX_CMDQ_CFG_RD_n,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
	...
	GEN_SRC_DST_ADDR_MAP_IDX(IPA_NTF_TX_CMDQ_CFG_RD_n,
			 ...
			 2),
	GEN_SRC_DST_ADDR_MAP(IPA_STATE_TX_1,
		     ipa_workarounds_debug_data.tsp_stop_ch_wa,
		     ipa_state_tx_1),

	/* ipa_reg_save_dlnlo_stop_ch_wa */
	GEN_SRC_DST_ADDR_MAP_ARR(IPA_ACKMNGR_CMDQ_STATUS_EMPTY_n,
		     ipa_workarounds_debug_data.dlnlo_stop_ch_wa,
		     ipa_ackmngr_cmdq_status_empty_n),
	GEN_SRC_DST_ADDR_MAP(IPA_RX_HPS_CMDQ_STATUS_EMPTY,
		     ipa_workarounds_debug_data.dlnlo_stop_ch_wa,
		     ipa_rx_hps_cmdq_status_empty),
	...
	IPA_REG_SAVE_GSI_VER(
			     GSI_INST_RAM_0,
			     gsi_top_gsi_inst_ram_0),
	
	/* GSI Mutex Registers */
	GEN_SRC_DST_ADDR_MAP(
			     GSI_IC_LOCK_BY_ORDER_EN,
			     gsi.gen,
			     gsi_ic_lock_by_order_en),
	GEN_SRC_DST_ADDR_MAP(
	...
	/* GSI Debug Registers */
	GEN_SRC_DST_ADDR_MAP(GSI_DEBUG_BUSY_REG,
			     gsi.debug,
			     gsi_top_gsi_debug_busy_reg),
	GEN_SRC_DST_ADDR_MAP_ARR(GSI_DEBUG_PC_FROM_SW_n,
			     gsi.debug,
			     gsi_top_gsi_debug_pc_from_sw_n),
	GEN_SRC_DST_ADDR_MAP(GSI_DEBUG_SW_STALL,
			     gsi.debug,
			     gsi_top_gsi_debug_sw_stall),
	GEN_SRC_DST_ADDR_MAP(GSI_DEBUG_PC_FOR_DEBUG,
			     gsi.debug,
			     gsi_top_gsi_debug_pc_for_debug),
	GEN_SRC_DST_ADDR_MAP(GSI_DEBUG_QSB_LOG_ERR_TRNS_ID,
			     gsi.debug,
			     gsi_top_gsi_debug_qsb_log_err_trns_id),
	...
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_CH_CMD,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_ch_cmd),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_EE_GENERIC_CMD,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_ee_generic_cmd),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_CH_DB,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_ch_db),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_NEW_RE,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_new_re),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_CH_DIS_COMP,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_ch_dis_comp),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_CH_EMPTY,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_ch_empty),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_EVENT_GEN_COMP,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_event_gen_comp),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_TIMER_EXPIRED,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_timer_expired),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_WRITE_ENG_COMP,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_write_eng_comp),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_READ_ENG_COMP,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_read_eng_comp),
	GEN_SRC_DST_ADDR_MAP(GSI_IRAM_PTR_INT_MOD_STOPED,
			     gsi.debug.gsi_iram_ptrs,
			     gsi_top_gsi_iram_ptr_int_mod_stoped),
	/* GSI SHRAM pointers Registers */
	GEN_SRC_DST_ADDR_MAP(GSI_SHRAM_PTR_CH_CNTXT_BASE_ADDR,
			     gsi.debug.gsi_shram_ptrs,
			     gsi_top_gsi_shram_ptr_ch_cntxt_base_addr),
	GEN_SRC_DST_ADDR_MAP(GSI_SHRAM_PTR_EV_CNTXT_BASE_ADDR,
			     gsi.debug.gsi_shram_ptrs,
			     gsi_top_gsi_shram_ptr_ev_cntxt_base_addr),
	GEN_SRC_DST_ADDR_MAP(GSI_SHRAM_PTR_RE_STORAGE_BASE_ADDR,
			     gsi.debug.gsi_shram_ptrs,
			     gsi_top_gsi_shram_ptr_re_storage_base_addr),
	GEN_SRC_DST_ADDR_MAP(GSI_SHRAM_PTR_RE_ESC_BUF_BASE_ADDR,
			     gsi.debug.gsi_shram_ptrs,
			     gsi_top_gsi_shram_ptr_re_esc_buf_base_addr),
	...
	IPA_REG_SAVE_CFG_ENTRY_GSI_GENERAL_EE(EE_n_CNTXT_GSI_IRQ_EN,
...
/* GSI Debug SW MSK Registers */
	...
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP_EXTRA(IPA_ENDP_INIT_CFG_n,
					       ipa_endp_init_cfg_n),
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP_EXTRA(IPA_ENDP_INIT_MODE_EXT_n,
					 ipa_endp_init_mode_ext_n),
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP_EXTRA(IPA_ENDP_INIT_ETHERNET_CFG_n,
					 ipa_endp_init_ethernet_cfg_n),
	...
	IPA_REG_SAVE_CFG_ENTRY_PIPE_ENDP_EXTRA(IPA_ENDP_INIT_ULSO_CFG_n,
					       ipa_endp_init_ulso_cfg_n),
#endif
};
...
void ipa_save_gsi_ver(void)
{
	...
	gsi_fw_ver = IPA_READ_1xVECTOR_REG(GSI_INST_RAM_0, 98);
...
void ipa_save_registers(void)
{
	...
	/* Starting IPAv7.0, there's a set of mcs_regs per MCS instance.
	   However, APPS can only ready MCS0 registers as it doesn't
	   have access to write the MCS selector register */
	...
	if (ipa3_ctx->do_non_tn_collection_on_crash) {
		for (i = 0; i < IPA_HW_PKT_CTNTX_MAX; i++) {
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f0) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_0, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f1) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_1, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f2) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_2, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f3) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_3, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f4) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_4, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f5) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_5, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f6) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_6, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f7) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_7, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f8) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_8, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f9) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_9, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f10) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_10, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f11) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_11, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f12) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_12, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f13) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_13, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f14) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_14, i);
			/* f15 missing */
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f16) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_16, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f17) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_17, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f18) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_18, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f19) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_19, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f20) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_20, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f21) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_21, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f22) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_22, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f23) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_23, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f24) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_24, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f25) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_25, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f26) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_26, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f27) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_27, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f28) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_28, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f29) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_29, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f30) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_30, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f31) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_31, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f32) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_32, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f33) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_33, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f34) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_34, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f35) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_35, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f36) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_36, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f37) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_37, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f38) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_38, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f39) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_39, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f40) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_40, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f41) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_41, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f42) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_42, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f43) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_43, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f44) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_44, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f45) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_45, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f46) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_46, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f47) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_47, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f48) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_48, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f49) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_49, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f50) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_50, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f51) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_51, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f52) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_52, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f53) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_53, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f54) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_54, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f55) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_55, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f56) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_56, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f57) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_57, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f58) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_58, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f59) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_59, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f60) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_60, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f61) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_61, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f62) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_62, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f63) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_63, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f64) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_64, i);
			*(u32*)(&ipa_reg_save.pkt_ctntx[i].f65) = IPA_READ_1xVECTOR_REG(IPA_PKT_CTX_NUM_m_FIELDS_65, i);
		}
		...
		for (i = 0; i < IPA_HW_PKT_CTNTX_MAX; i++) {
			...
			if (for_read.def.rsrc_occupied) {
				...
				ipa_reg_save.pkt_cntxt_state[i] =
					...
					ipa_reg_save.pkt_ctntx[i].f0.state;
			}
		}
	}
...
static void ipa_reg_save_rsrc_cnts(void)
{
	union ipa_hwio_def_ipa_src_rsrc_type_cnt_0_wout_ack_entry_grp_n_u
		src_rsrc_type_cnt_0_wout_ack_entry;
	union ipa_hwio_def_ipa_src_rsrc_type_cnt_1_ack_entry_grp_n_u
		src_rsrc_type_cnt_1_ack_entry;
	...
	/* Source for Group 0 - pcie*/
	src_rsrc_type_cnt_0_wout_ack_entry.value =
		IPA_READ_1xVECTOR_REG(IPA_SRC_RSRC_TYPE_CNT_0_WOUT_ACK_ENTRY_GRP_n, 0);
	src_rsrc_type_cnt_1_ack_entry.value =
		IPA_READ_1xVECTOR_REG(IPA_SRC_RSRC_TYPE_CNT_1_ACK_ENTRY_GRP_n, 0);

	ipa_reg_save.rsrc_cnts.pcie.src.pkt_cntxt =
		src_rsrc_type_cnt_0_wout_ack_entry.def.rsrc_type_src_ctx_cnt;
	ipa_reg_save.rsrc_cnts.pcie.src.data_descriptor_buffer =
		src_rsrc_type_cnt_0_wout_ack_entry.def.rsrc_type_src_desc_buffer_cnt;
	ipa_reg_save.rsrc_cnts.pcie.src.hps_dmars =
		src_rsrc_type_cnt_0_wout_ack_entry.def.rsrc_type_src_hps_dmar_cnt;
	ipa_reg_save.rsrc_cnts.pcie.src.reserved_acks =
		src_rsrc_type_cnt_1_ack_entry.def.rsrc_type_src_ack_entry_cnt;

	/* Source for Group 1 - ddr*/
	src_rsrc_type_cnt_0_wout_ack_entry.value =
		IPA_READ_1xVECTOR_REG(IPA_SRC_RSRC_TYPE_CNT_0_WOUT_ACK_ENTRY_GRP_n, 1);
	src_rsrc_type_cnt_1_ack_entry.value =
		IPA_READ_1xVECTOR_REG(IPA_SRC_RSRC_TYPE_CNT_1_ACK_ENTRY_GRP_n, 1);

	/* Dest for Group 0 - pcie*/
	dst_rsrc_type_cnt.value =
		IPA_READ_1xVECTOR_REG(IPA_DST_RSRC_TYPE_CNT_GRP_n, 0);

	ipa_reg_save.rsrc_cnts.pcie.dst.data_sectors =
		dst_rsrc_type_cnt.def.rsrc_type_dst_data_sctr_cnt;
	ipa_reg_save.rsrc_cnts.pcie.dst.dps_dmars =
		dst_rsrc_type_cnt.def.rsrc_type_dst_dps_dmar_cnt;
	ipa_reg_save.rsrc_cnts.pcie.dst.seg_ctx =
		dst_rsrc_type_cnt.def.rsrc_type_dst_seg_ctx_cnt;

	/* Dest for Group 1 - ddr*/
	dst_rsrc_type_cnt.value =
		IPA_READ_1xVECTOR_REG(IPA_DST_RSRC_TYPE_CNT_GRP_n, 1);

	ipa_reg_save.rsrc_cnts.ddr.dst.data_sectors =
		dst_rsrc_type_cnt.def.rsrc_type_dst_data_sctr_cnt;
	ipa_reg_save.rsrc_cnts.ddr.dst.dps_dmars =
		dst_rsrc_type_cnt.def.rsrc_type_dst_dps_dmar_cnt;
	ipa_reg_save.rsrc_cnts.ddr.dst.seg_ctx =
		dst_rsrc_type_cnt.def.rsrc_type_dst_seg_ctx_cnt;
}
/*
