...
#define IPA_WRAPPER_BASE 0 /* required by following includes */
...
#define IPA_REG_DUMP_MAX_MCS_NUM						  3
...
#define IPA_REG_SAVE_CFG_ENTRY_DST_RSRC_GRP(reg_name, var_name) \
	...
	{ GEN_1xVECTOR_REG_OFST(reg_name, 2), \
		...
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 3), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[3].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 4), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[4].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 5), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[5].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 6), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[6].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 7), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[7].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 8), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[8].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 9), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[9].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 10), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_grp[10].var_name, \
		GEN_REG_ATTR(reg_name) }
/*
...
#define IPA_REG_SAVE_CFG_ENTRY_DST_RSRC_CNT_GRP(reg_name, var_name) \
	...
	{ GEN_1xVECTOR_REG_OFST(reg_name, 2), \
		...
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 3), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[3].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 4), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[4].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 5), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[5].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 6), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[6].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 7), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[7].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 8), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[8].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 9), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[9].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 10), \
		(u32 *)&ipa_reg_save.ipa.dst_rsrc_cnt[10].var_name, \
		GEN_REG_ATTR(reg_name) }
/*
 * Macro to define a particular register cfg entry for all dest
 * resource group count register
...
#define IPA_REG_SAVE_CFG_ENTRY_GSI_CH_CNTXT(reg_name, var_name) \
	...
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 30), \
		...
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 31), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[31].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 32), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[32].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 33), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[33].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 34), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[34].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 35), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[35].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 36), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[36].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 37), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[37].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 38), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[38].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 39), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[39].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 40), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[40].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 41), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[41].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 42), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[42].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 43), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[43].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 44), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[44].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 45), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[45].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 46), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[46].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 47), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[47].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 48), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[48].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 49), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[49].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 50), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[50].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 51), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[51].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 52), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[52].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 53), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[53].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 54), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[54].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 55), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[55].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 56), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[56].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 57), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[57].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 58), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[58].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 59), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[59].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 60), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[60].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 61), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[61].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 62), \
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.a7[62].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	...
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 11),	\
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.q6[11].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 12),	\
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.q6[12].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 13),	\
		(u32 *)&ipa_reg_save.gsi.ch_cntxt.q6[13].var_name, \
		GEN_REG_ATTR(reg_name) }
...
#define IPA_REG_SAVE_CFG_ENTRY_GSI_EVT_CNTXT(reg_name, var_name) \
	...
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 30), \
		...
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 31), \
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.a7[31].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 32), \
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.a7[32].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 33), \
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.a7[33].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 34), \
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.a7[34].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 35), \
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.a7[35].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 36), \
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.a7[36].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	...
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 11),	\
		...
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 12),	\
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.q6[12].var_name, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 13),	\
		(u32 *)&ipa_reg_save.gsi.evt_cntxt.q6[13].var_name, \
		GEN_REG_ATTR(reg_name) }
...
/*
 * helper macro to save array register of MAXn = 2
 */
#define GEN_SRC_DST_ADDR_MAP_ARR_2(reg_name, sub_struct, var_name) \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 0), \
		(u32 *)&ipa_reg_save.sub_struct.var_name[0], \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 1), \
...
/*
 * helper macro to save array register of MAXn = 3
 */
#define GEN_SRC_DST_ADDR_MAP_ARR_3(reg_name, sub_struct, var_name) \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 0), \
		(u32 *)&ipa_reg_save.sub_struct.var_name[0], \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_1xVECTOR_REG_OFST(reg_name, 1), \
...
/*
 * helper macro to save EE array register of MAXk = 2
 */
#define GEN_SRC_DST_ADDR_MAP_EE_n_REG_k_ARR_2(reg_name, sub_struct, var_name) \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 0), \
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_A7_EE].var_name.arr[0].value, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 1), \
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_A7_EE].var_name.arr[1].value, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_A7_EE, 2), \
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_A7_EE].var_name.arr[2].value, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 0), \
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_Q6_EE].var_name.arr[0].value, \
		GEN_REG_ATTR(reg_name) }, \
	...
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_Q6_EE].var_name.arr[1].value, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_Q6_EE, 2), \
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_Q6_EE].var_name.arr[2].value, \
		GEN_REG_ATTR(reg_name) }, \
	{ GEN_2xVECTOR_REG_OFST(reg_name, IPA_HW_UC_EE, 0), \
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_UC_EE].var_name.arr[0].value, \
		GEN_REG_ATTR(reg_name) }, \
	...
	(u32 *)&ipa_reg_save.sub_struct[IPA_HW_UC_EE].var_name.arr[2].value, \
		GEN_REG_ATTR(reg_name) }
...
struct ipa_gen_regs_s {
	...
	struct ipa_hwio_def_ipa_tsp_ingress_policing_cfg_n_s
	  ipa_tsp_ingress_policing_cfg_n[GEN_MAX_n(IPA_TSP_INGRESS_POLICING_CFG_n) + 1];
	struct ipa_hwio_def_ipa_tsp_ingress_policing_cfg_eth_n_s
	  ipa_tsp_ingress_policing_cfg_eth_n[GEN_MAX_n(IPA_TSP_INGRESS_POLICING_CFG_ETH_n) + 1];
	struct ipa_hwio_def_ipa_tsp_egress_policing_cfg_n_s
	  ipa_tsp_egress_policing_cfg_n[GEN_MAX_n(IPA_TSP_EGRESS_POLICING_CFG_n) + 1];
	struct ipa_hwio_def_ipa_state_qmngr_queue_nonempty_n_s
	  ipa_state_qmngr_queue_nonempty_n[GEN_MAX_n(IPA_STATE_QMNGR_QUEUE_NONEMPTY_n) + 1];
	struct ipa_hwio_def_ipa_state_prod_dpl_fifo_s
	...
	struct ipa_hwio_def_ipa_ulso_cfg_ip_id_min_value_n_s
	  ipa_ulso_cfg_ip_id_min_value_n[GEN_MAX_n(IPA_ULSO_CFG_IP_ID_MIN_VALUE_n) + 1];
	struct ipa_hwio_def_ipa_ulso_cfg_ip_id_max_value_n_s
	  ipa_ulso_cfg_ip_id_max_value_n[GEN_MAX_n(IPA_ULSO_CFG_IP_ID_MAX_VALUE_n) + 1];
...
struct ipa_reg_save_gsi_iram_ptr_regs_s {
	...
	struct gsi_hwio_def_gsi_iram_ptr_int_mod_canceled_s
		gsi_top_gsi_iram_ptr_int_mod_canceled;
};
...
struct ipa_reg_save_gsi_shram_ptr_regs_s {
	...
	struct gsi_hwio_def_gsi_shram_ptr_func_stack_base_addr_n_s
	  gsi_top_gsi_shram_ptr_func_stack_base_addr_n;
};
...
struct ipa_reg_save_gsi_debug_s {
	...
	struct gsi_hwio_def_gsi_debug_pc_from_sw_n_s
	  gsi_top_gsi_debug_pc_from_sw_n[GEN_MAX_n(GSI_DEBUG_PC_FROM_SW_n) + 1];
...
struct ipa_regs_save_hierarchy_s {
	...
	struct ipa_reg_save_src_rsrc_grp_s
		src_rsrc_grp[IPA_HW_SRC_RSRP_GRP_MAX];
	struct ipa_reg_save_dst_rsrc_grp_s
		dst_rsrc_grp[IPA_HW_DST_RSRP_GRP_MAX];
	struct ipa_reg_save_src_rsrc_cnt_s
		src_rsrc_cnt[IPA_HW_SRC_RSRP_GRP_MAX];
	struct ipa_reg_save_dst_rsrc_cnt_s
		dst_rsrc_cnt[IPA_HW_DST_RSRP_GRP_MAX];
	u32 *ipa_iu_ptr;
	u32 *ipa_sram_ptr;
	u32 *ipa_mbox_ptr;
	u32 *ipa_hram_ptr;
