...
#define IPA_ETH_MAX_RX_DMA_CHANNEL_QOS 4
#define IPA_ETH_MAX_TX_DMA_CHANNEL_QOS 5
#define IPA_ETH_MAX_DMA_CHANNEL_QOS 9
...
#define IPA_CLIENT_IS_WLAN_PROD(x) \
			((x == ipa3_get_ep_mapping(IPA_CLIENT_WLAN2_PROD)) || \
			 (x == ipa3_get_ep_mapping(IPA_CLIENT_WLAN3_PROD)) || \
			 (x == ipa3_get_ep_mapping(IPA_CLIENT_WLAN1_PROD)))
