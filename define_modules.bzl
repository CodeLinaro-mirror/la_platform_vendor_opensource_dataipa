...
def define_modules(target, variant):
    ...
    ddk_module(
        name = "{}-defconfig_gsim".format(kernel_build_variant),
        out = "gsim.ko",
        srcs = [
    ...
    mod_list.append("{}-defconfig_gsim".format(kernel_build_variant))

    ddk_module(
        name = "{}-defconfig_ipam".format(kernel_build_variant),
        out = "ipam.ko",
        srcs = [
            ...
            "drivers/platform/msm/ipa/ipa_v3/ipa_sysfs.c",
            "drivers/platform/msm/ipa/ipa_v3/ipa_sysfs.h",
            "drivers/platform/msm/ipa/ipa_v3/ipa_rc.c",
            "drivers/platform/msm/ipa/ipa_v3/ipa_rc.h",
            "drivers/platform/msm/ipa/test/ipa_rc_test.c",
            ...
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/gsi_hwio.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/gsi_hwio_def.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_access_control.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_gcc_hwio.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_gcc_hwio_def.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_hw_common_ex.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_hwio.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_hwio_def.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_pkt_cntxt.h",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_reg_dump.c",
            "drivers/platform/msm/ipa/ipa_v3/dump/ipa6.0/ipa_reg_dump.h",
        ...
        deps = [
            ...
            ":ipa_clients",
            "//msm-kernel:all_headers",
            ":{}-defconfig_gsim".format(kernel_build_variant),
        ],
    )
    mod_list.append("{}-defconfig_ipam".format(kernel_build_variant))

    ddk_module(
        name = "{}-defconfig_ipanetm".format(kernel_build_variant),
        out = "ipanetm.ko",
        srcs = [
    ...
    if variant == "debug":
        ...
        mod_list.append("{}-defconfig_ipatestm".format(kernel_build_variant))

    copy_to_dist_dir(
        name = "{}-defconfig_dataipa_dist".format(kernel_build_variant),
        data = mod_list,
